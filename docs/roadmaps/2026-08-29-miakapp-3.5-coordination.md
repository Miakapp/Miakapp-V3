...
1. protocol RFC and golden binary fixtures;
...
1. Amend the ecosystem design with the corrected relay and component trust
   boundaries.
2. Write the protocol RFC before writing the Go server.
...
Overall confidence in this sequencing is **high**. Confidence in the final wire
format, push-grant design, and component artifact-delivery mechanism is
**medium** until their dedicated design passes and adversarial prototypes are
complete.
