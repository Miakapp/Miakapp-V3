...
Contract status (2026-08-31): RFC 0004 and `control-plane-contract/` are
accepted. The deliverables below are production implementation work and remain
open until emulator and staging evidence passes.
