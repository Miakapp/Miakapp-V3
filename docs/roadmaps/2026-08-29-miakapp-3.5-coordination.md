...
7. emulator-first tests for rules and Functions — the Section 5–7 slice is
   ...
   plus component publication/read-back and pointer activation; production
   service integration, remaining fault injection and admission evidence are
   open.
...
8. **In progress 2026-09-01** — the emulator implementation now covers closed FID
   ...
   concurrent CAS, quarantine and rollback; next add bounded audit/rate/cost
   admission and the remaining RFC 0004 Section 18 fault matrix before staging.
