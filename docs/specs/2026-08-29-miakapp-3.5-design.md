...
3. **Platform control plane — closed 2026-08-31** — RFC 0004 defines owner
   ...
   plus a bounded behavioral model. Firebase Emulator and staging behavior remain
...
the web repository may implement the RFC 0004 Firebase Emulator slice. Their
session machines, authorization, rules, Functions, queueing and disconnect
behavior still have to pass vertical-slice tests; contract-kit self-conformance
