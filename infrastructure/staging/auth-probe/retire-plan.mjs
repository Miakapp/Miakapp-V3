...
async function main() {
  ...
  try {
    ...
    const planned = run('terraform', [
      ...
      '-target=google_project_iam_custom_role.auth_probe_generation_2',
      '-target=google_project_iam_custom_role.auth_probe_firestore_generation_2',
      '-target=google_project_iam_custom_role.auth_probe_signer_generation_2',
