output "staging_browser_app_check_key" {
  ...
  value = {
    ...
    app_check_config_name     = google_firebase_app_check_recaptcha_enterprise_config.browser_app_check.name
    app_check_token_ttl       = google_firebase_app_check_recaptcha_enterprise_config.browser_app_check.token_ttl
    app_check_site_key_sha256 = sha256(google_firebase_app_check_recaptcha_enterprise_config.browser_app_check.site_key)
