...
node infrastructure/staging/browser-relay-page/guard.mjs \
  "${repository_root}/infrastructure/staging/browser-relay-page"
node --check infrastructure/staging/browser-relay-page/artifact.mjs
node --check infrastructure/staging/browser-relay-page/boundary.mjs
node --check infrastructure/staging/browser-relay-page/contract.mjs
...
node infrastructure/staging/browser-relay-fixture-cloud/guard.mjs \
  "${repository_root}/infrastructure/staging/browser-relay-fixture-cloud"
node --check infrastructure/staging/browser-relay-fixture-cloud/cloud.mjs
...
node infrastructure/staging/browser-relay-aggregator/guard.mjs \
  "${repository_root}/infrastructure/staging/browser-relay-aggregator"
node --check infrastructure/staging/browser-relay-aggregator/aggregator.mjs
...
node infrastructure/staging/browser-relay-case-scheduler/guard.mjs \
  "${repository_root}/infrastructure/staging/browser-relay-case-scheduler"
node --check infrastructure/staging/browser-relay-case-scheduler/contract.mjs
node --check infrastructure/staging/browser-relay-case-scheduler/guard.mjs
node --check infrastructure/staging/browser-relay-case-scheduler/internal.mjs
...
node --check infrastructure/staging/browser-relay-playwright-bridge/contract.mjs
node --check infrastructure/staging/browser-relay-playwright-bridge/guard.mjs
node --check infrastructure/staging/test/browser-relay-playwright-bridge-browser.mjs
node --check infrastructure/staging/test/helpers/browser-relay-playwright-bridge-entry.mjs
node -e "import('./infrastructure/staging/browser-relay-playwright-bridge/contract.mjs').then(({ validateBrowserRelayPlaywrightBridgeProfile }) => validateBrowserRelayPlaywrightBridgeProfile())"
node infrastructure/staging/browser-relay-secondary-case-adapter/guard.mjs \
  "${repository_root}/infrastructure/staging/browser-relay-secondary-case-adapter"
node --check infrastructure/staging/browser-relay-secondary-case-adapter/adapter.mjs
node --check infrastructure/staging/browser-relay-secondary-case-adapter/contract.mjs
node --check infrastructure/staging/browser-relay-secondary-case-adapter/guard.mjs
node --check infrastructure/staging/browser-relay-secondary-case-adapter/internal.mjs
...
node infrastructure/staging/browser-relay-authenticated-source-readers/guard.mjs \
  "${repository_root}/infrastructure/staging/browser-relay-authenticated-source-readers"
node --check infrastructure/staging/browser-relay-authenticated-source-readers/contract.mjs
node --check infrastructure/staging/browser-relay-authenticated-source-readers/guard.mjs
node --check infrastructure/staging/browser-relay-authenticated-source-readers/internal.mjs
...
node infrastructure/staging/browser-relay-source-session-producers/guard.mjs \
  "${repository_root}/infrastructure/staging/browser-relay-source-session-producers"
node --check infrastructure/staging/browser-relay-source-session-producers/contract.mjs
node --check infrastructure/staging/browser-relay-source-session-producers/guard.mjs
node --check infrastructure/staging/browser-relay-source-session-producers/internal.mjs
...
node infrastructure/staging/browser-relay-scenario-fixture/guard.mjs \
  "${repository_root}/infrastructure/staging/browser-relay-scenario-fixture"
node --check infrastructure/staging/browser-relay-scenario-fixture/contract.mjs
