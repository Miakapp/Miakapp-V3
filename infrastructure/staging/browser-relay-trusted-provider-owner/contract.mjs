...
export const TRUSTED_PROVIDER_OWNER_PROFILE_SHA256 =
  '8c480f3970f196275096a9845e2873c0ce6d9f4232c081371a89bfc1d8470d44';
export const TRUSTED_PROVIDER_OWNER_PROFILE_V1_SHA256 =
...
export const TRUSTED_PROVIDER_OWNER_DEPENDENCY_CONTRACTS_SHA256 =
  '9708d4fa87b99961a093cfa1ce4cc1f197880bd999a111496fb6a3fe2c12eaa9';
export const TRUSTED_PROVIDER_OWNER_INTERNAL_SOURCE_SHA256 =
  'b691a42a59db839d8e4424ef76ed19f559c4a3b84be0e320c6752a9c5e77afea';
export const TRUSTED_PROVIDER_OWNER_ENTRY_SOURCE_SHA256 =
  'c848545b31f3411b08a67d902037240938ca75304627f39652dbb7200cd132b5';
...
export const TRUSTED_PROVIDER_OWNER_SOURCE_SHA256 =
  '24711f72953132b02110edf9c9545ad48df8ada52aafc77be9519a1098e31607';
export const TRUSTED_PROVIDER_OWNER_TESTING_SOURCE_SHA256 =
  'd05fba653662cf1890d245cb7cefc9a28c7a19a53dc7ca119fa5e1e125f5a64e';
...
export const TRUSTED_PROVIDER_OWNER_GUARD_SOURCE_SHA256 =
  'fe285e09e4a85fa2f272dac26bd811d25664b9e8940003d3a47b1d69a305aaef';
export const TRUSTED_PROVIDER_OWNER_UNIT_TEST_SHA256 =
  '367c3b18976ae3f01e67b44261e784ff409a0953dace01ac45064487a0401e9b';
export const TRUSTED_PROVIDER_OWNER_BUNDLE_TEST_SHA256 =
  'a113f398ee0c00aec9bcdaa6eebe7ad7d408bdc6242f18cdbbfbae290e1f1aeb';
export const TRUSTED_PROVIDER_OWNER_BROWSER_TEST_SHA256 =
  '0244e73456bd448202c8b9c97805bc57f4c98132d8105f78df408f3ef7500669';
...
export const TRUSTED_PROVIDER_OWNER_BOOTSTRAP_FIELDS = Object.freeze(['authority']);
export const TRUSTED_PROVIDER_OWNER_EPHEMERAL_AUTHORITY_FIELDS =
  Object.freeze(['consume']);
...
export function validateTrustedProviderOwnerBootstrap(value) {
  try {
    const bootstrap = directRecord(value, TRUSTED_PROVIDER_OWNER_BOOTSTRAP_FIELDS, true);
    const authority = directRecord(
      bootstrap.authority,
...
export function validateTrustedProviderOwnerAuthorityBytes(value) {
  try {
    ...
    if (!INTRINSIC_IS_BUFFER(value) || INTRINSIC_IS_PROXY(value)
...
function validateProfileSemantics(profile) {
  ...
  exact(profile.pins.profile_v1_sha256, TRUSTED_PROVIDER_OWNER_PROFILE_V1_SHA256);
  ...
  exact(profile.ephemeral_authority, {
  ...
  exact(profile.lifecycle.authority_consume_calls_per_execution, 1);
  exact(profile.lifecycle.authority_consume_wraps_owner_execution, true);
  exact(profile.evidence.blocked_external_request_probes, 4);
  exact(profile.evidence.synthetic_authority_consumptions, 1);
  exact(profile.evidence.real_credentials_used, 0);
  exact(profile.evidence.authority_persistence_events, 0);
  exact(profile.authority, {
    process_ephemeral_authority_capability_authorized: true,
    synthetic_opaque_authority_authorized_for_offline_proof: true,
