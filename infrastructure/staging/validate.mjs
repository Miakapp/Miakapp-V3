...
import {
  ...
  CHROMIUM_CASE_ADAPTER_IMPLEMENTATION_BASE_COMMIT,
...
import {
  ...
  SECONDARY_CASE_ADAPTER_IMPLEMENTATION_BASE_COMMIT,
...
import {
  ...
  AUTHENTICATED_SOURCE_READERS_PROVIDER_METHODS,
  AUTHENTICATED_SOURCE_READERS_READER_METHODS,
  AUTHENTICATED_SOURCE_READERS_REQUEST_FIELDS,
...
import {
  ...
  TRUSTED_SOURCE_COMPOSITION_OPTIONS_FIELDS,
  ...
  TRUSTED_SOURCE_COMPOSITION_ROOT_FIELDS,
...
const INDEPENDENT_OBSERVERS_CONTRACT_SHA256 =
  '44a63fc2a6ab196dcf9579579c24396caa346c13e48f434e1b3dfe6d7930b0dd';
const EVIDENCE_SESSION_CONTRACT_SHA256 =
  '4a32e8963a3cd881407f801cb1ea68b275cabaa1f670c52a1343a440806c6b35';
const CASE_SCHEDULER_CONTRACT_SHA256 =
  '1665dd419dfe5e4d601a70e4f7de9935ef254b6b2a5b4c6577f87d5fda2a5187';
const CHROMIUM_SCENARIO_CONTRACT_SHA256 =
  '61feb77fcfc61018c302f1fc698cc00645a7a5e4407f6fd270622312b7bc8a79';
const CHROMIUM_CASE_ADAPTER_CONTRACT_SHA256 =
  '52e0223e4ea7852dcdd4c0a320acf7b381303ad3bf3edf286abbf0a8c56d782e';
const SECONDARY_CASE_ADAPTER_CONTRACT_SHA256 =
  '764a05ac206460ebd794180b58d17c65b7080918202b6d581fc3a595f683c246';
const INDEPENDENT_CASE_ADAPTER_CONTRACT_SHA256 =
  '53ca85ed242fe63e85824dcc52948f4544cec5e6c42e7254bd742ce1c2510c01';
const SOURCE_TRANSPORTS_CONTRACT_SHA256 =
...
const SOURCE_AUTHORITY_ADAPTERS_CONTRACT_SHA256 =
  '9ba75de5ac5b19b840a0379b09ce5ede37445ee49fc35520f4bbc152726b27ff';
const SOURCE_SESSION_PRODUCERS_CONTRACT_SHA256 =
  '3f04c05190c79e56b275f06810302d69a368b3d471b36dc7b22355eb3fae0406';
const SOURCE_CLIENTS_CONTRACT_SHA256 =
  '01df6c32380a7c70df29d87ef3dc7f8acdd4984f8e6f00763772fa71ed5a19b9';
const EXTERNAL_ADAPTERS_WORKFLOW_SHA256 =
  '48f3935b940a094f6b45dd8a80ed06be39ee50398884c7e95f8ec9388479f50d';
const OPERATOR_AUTHORITY_SOURCE_DIGESTS = Object.freeze({
  contract_source_sha256: 'e8499a65e6bf8bcec37952ef802228d874e108bedb8b72dcb4fd811c7556cc27',
  internal_source_sha256: '9fd651ba63b776d829b5945670d526aed93607f1978ca6aa5c6e1394b2bf9a2f',
  production_source_sha256: '04ea705d2546371bf621d9499989b9aabb9ba6d0b247c2443cdea8c214b37db0',
  testing_source_sha256: '96bcf52c49c55c3ef092534de5e21b942005b33ab235578db5e4f0e20850fad0',
  guard_source_sha256: '3ea6c2e5a0058bfd2f678dd10e82f5b02a5f7006abef85532857bf51bdc1faf8',
  check_source_sha256: 'd59d4d0c390124a46c1e384bf52b67860626e36a62408248fe4e80afb8368e65',
  readme_sha256: '8a1212488c58f11f85b2a8d92cb286536cb795f05ed9fc3723af92babaf993c3',
  unit_test_sha256: '930880d9cc3320b8c20e58b908a641c71c5aef92e67155a5ce48a94940d3c151',
  workflow_sha256: EXTERNAL_ADAPTERS_WORKFLOW_SHA256,
});
const HOSTING_PUBLISHER_DIGESTS = Object.freeze({
  contract_source_sha256: 'fce7440e67136aa502c3b99b51a67d2053953df9d74015d620502d1acb5cc822',
  internal_source_sha256: 'b2472bad4129b09ffa436be940bca8cc8debf9644c0fc8e932d41aedea229362',
  production_source_sha256: '3c886e9ec4d808917593a5b5dd33d9980d583eafc5f5478661e7120e57be7faf',
  testing_source_sha256: '952e4bd15073205a68d3518ce410decd59ce8c6f3a4a4a99847de397d4369aa8',
  guard_source_sha256: '1b1752e111f6a0a3d02650745314b7b31bb8bed53d570eda88cbb97c546af2d9',
  check_source_sha256: '4d246638bac1d802f5e46daae222b6dbb6a5cb6c04dbfc7f2f6ec8c9d53405fd',
  readme_sha256: 'f63c0b896ea5b62e664d340765210dcefe343c14865fbe9e55fff3df3a150f9c',
  unit_test_sha256: '6e2c5462be996f1ae3fab0c88b8ecb6aee5e34fb7f25d9fe8ca4d90cc8c1caee',
  workflow_sha256: EXTERNAL_ADAPTERS_WORKFLOW_SHA256,
});
...
const TRUSTED_PROVIDER_PROCESS_CONTRACT_SHA256 =
  '1ebbeb8dd710cb730eae85bcb45b8ccb8ecf4c424143f9f20057937c3085b43e';
const TRUSTED_PROVIDER_OWNER_CONTRACT_SHA256 =
  'e3d3eacdeb2f8ccb1ed9105b8f3ab172579f0e29a54fb2f0dc662f01e1aed7f4';
...
export function validateStagingManifest(value) {
  ...
  exact(manifest.revision, 110, 'manifest.revision');
  exact(
    manifest.status,
...
function exactStructured(value, expected, path) {
  if (JSON.stringify(value) !== JSON.stringify(expected)) {
    reject(path, 'must equal its exact committed profile projection');
  }
}
...
export function validateCommittedEvidence(
  ...
  const chromiumCaseAdapterManifest =
    manifest.evidence.browser_relay_chromium_case_adapter;
  const chromiumCaseAdapterProfilePath = committedEvidencePath(
    stagingRoot,
    chromiumCaseAdapterManifest.profile_path,
    CHROMIUM_CASE_ADAPTER_PROFILE_PATH,
    'evidence.browser_relay_chromium_case_adapter.profile_path',
  );
  const chromiumCaseAdapterProfile = validatedEvidenceFile(
    chromiumCaseAdapterProfilePath,
    validateBrowserRelayChromiumCaseAdapterProfile,
    'evidence.browser_relay_chromium_case_adapter.profile_path',
  );
  exact(
    fileSha256(chromiumCaseAdapterProfilePath),
    CHROMIUM_CASE_ADAPTER_PROFILE_SHA256,
    'evidence.browser_relay_chromium_case_adapter.profile_sha256',
  );
  exact(
    fileSha256(resolve(stagingRoot, 'browser-relay-chromium-case-adapter/contract.mjs')),
    CHROMIUM_CASE_ADAPTER_CONTRACT_SHA256,
    'evidence.browser_relay_chromium_case_adapter.contract_source_sha256',
  );
  const chromiumCaseAdapterExpected = {
    state: chromiumCaseAdapterProfile.state,
    profile_path: CHROMIUM_CASE_ADAPTER_PROFILE_PATH,
    profile_sha256: CHROMIUM_CASE_ADAPTER_PROFILE_SHA256,
    profile_schema: chromiumCaseAdapterProfile.schema,
    profile_revision: chromiumCaseAdapterProfile.revision,
    contract_source_sha256: CHROMIUM_CASE_ADAPTER_CONTRACT_SHA256,
    target: chromiumCaseAdapterProfile.target,
    pins: chromiumCaseAdapterProfile.pins,
    composition: chromiumCaseAdapterProfile.composition,
    controls: chromiumCaseAdapterProfile.controls,
    trust_boundary: chromiumCaseAdapterProfile.trust_boundary,
    compatibility: chromiumCaseAdapterProfile.compatibility,
    output: chromiumCaseAdapterProfile.output,
    authority: chromiumCaseAdapterProfile.authority,
    evidence: chromiumCaseAdapterProfile.evidence,
  };
  record(
    chromiumCaseAdapterManifest,
    'evidence.browser_relay_chromium_case_adapter',
    Object.keys(chromiumCaseAdapterExpected),
  );
  exactStructured(
    chromiumCaseAdapterManifest,
    chromiumCaseAdapterExpected,
    'evidence.browser_relay_chromium_case_adapter',
  );
  exact(
    chromiumCaseAdapterProfile.pins.browser_relay_case_scheduler_profile_sha256,
    CASE_SCHEDULER_PROFILE_SHA256,
    'evidence.browser_relay_chromium_case_adapter.pins.browser_relay_case_scheduler_profile_sha256',
  );
  exact(
    chromiumCaseAdapterProfile.pins.browser_relay_chromium_scenario_profile_sha256,
    CHROMIUM_SCENARIO_PROFILE_SHA256,
    'evidence.browser_relay_chromium_case_adapter.pins.browser_relay_chromium_scenario_profile_sha256',
  );
  exact(
    chromiumCaseAdapterProfile.pins.browser_relay_scenario_fixture_profile_sha256,
    SCENARIO_FIXTURE_PROFILE_SHA256,
    'evidence.browser_relay_chromium_case_adapter.pins.browser_relay_scenario_fixture_profile_sha256',
  );
  exact(
    chromiumCaseAdapterProfile.pins.browser_relay_evidence_session_profile_sha256,
    EVIDENCE_SESSION_PROFILE_SHA256,
    'evidence.browser_relay_chromium_case_adapter.pins.browser_relay_evidence_session_profile_sha256',
  );
  exact(
    chromiumCaseAdapterProfile.pins.browser_relay_page_receipt_profile_sha256,
    PAGE_RECEIPT_PROFILE_SHA256,
    'evidence.browser_relay_chromium_case_adapter.pins.browser_relay_page_receipt_profile_sha256',
  );
  exact(
    chromiumCaseAdapterProfile.pins.browser_relay_runner_profile_sha256,
    BROWSER_RELAY_RUNNER_PROFILE_SHA256,
    'evidence.browser_relay_chromium_case_adapter.pins.browser_relay_runner_profile_sha256',
  );
  exact(
    chromiumCaseAdapterProfile.pins.dependency_contracts_sha256,
    CHROMIUM_CASE_ADAPTER_DEPENDENCY_CONTRACTS_SHA256,
    'evidence.browser_relay_chromium_case_adapter.pins.dependency_contracts_sha256',
  );
  exact(
    chromiumCaseAdapterProfile.pins.implementation_base_commit,
    CHROMIUM_CASE_ADAPTER_IMPLEMENTATION_BASE_COMMIT,
    'evidence.browser_relay_chromium_case_adapter.pins.implementation_base_commit',
  );
  exact(
    chromiumCaseAdapterProfile.compatibility.case_scheduler_composed,
    true,
    'evidence.browser_relay_chromium_case_adapter.compatibility.case_scheduler_composed',
  );
  exact(
    chromiumCaseAdapterProfile.compatibility.complete_chromium_page_scenario_composed,
    true,
    'evidence.browser_relay_chromium_case_adapter.compatibility.complete_chromium_page_scenario_composed',
  );
  exact(
    chromiumCaseAdapterProfile.compatibility.independent_live_source_adapters_present,
    false,
    'evidence.browser_relay_chromium_case_adapter.compatibility.independent_live_source_adapters_present',
  );
  exact(
    chromiumCaseAdapterProfile.compatibility.secondary_live_browser_drivers_present,
    false,
    'evidence.browser_relay_chromium_case_adapter.compatibility.secondary_live_browser_drivers_present',
  );
  exact(
    chromiumCaseAdapterProfile.compatibility.live_operation_wired,
    false,
    'evidence.browser_relay_chromium_case_adapter.compatibility.live_operation_wired',
  );
  exact(
    chromiumCaseAdapterProfile.authority.live_execution_authorized,
    false,
    'evidence.browser_relay_chromium_case_adapter.authority.live_execution_authorized',
  );
  exact(
    chromiumCaseAdapterProfile.evidence.live_execution_count,
    0,
    'evidence.browser_relay_chromium_case_adapter.evidence.live_execution_count',
  );
  const secondaryCaseAdapterManifest =
    manifest.evidence.browser_relay_secondary_case_adapter;
  const secondaryCaseAdapterProfilePath = committedEvidencePath(
    stagingRoot,
    secondaryCaseAdapterManifest.profile_path,
    SECONDARY_CASE_ADAPTER_PROFILE_PATH,
    'evidence.browser_relay_secondary_case_adapter.profile_path',
  );
  const secondaryCaseAdapterProfile = validatedEvidenceFile(
    secondaryCaseAdapterProfilePath,
    validateBrowserRelaySecondaryCaseAdapterProfile,
    'evidence.browser_relay_secondary_case_adapter.profile_path',
  );
  exact(
    fileSha256(secondaryCaseAdapterProfilePath),
    SECONDARY_CASE_ADAPTER_PROFILE_SHA256,
    'evidence.browser_relay_secondary_case_adapter.profile_sha256',
  );
  exact(
    fileSha256(resolve(stagingRoot, 'browser-relay-secondary-case-adapter/contract.mjs')),
    SECONDARY_CASE_ADAPTER_CONTRACT_SHA256,
    'evidence.browser_relay_secondary_case_adapter.contract_source_sha256',
  );
  const secondaryCaseAdapterExpected = {
    state: secondaryCaseAdapterProfile.state,
    profile_path: SECONDARY_CASE_ADAPTER_PROFILE_PATH,
    profile_sha256: SECONDARY_CASE_ADAPTER_PROFILE_SHA256,
    profile_schema: secondaryCaseAdapterProfile.schema,
    profile_revision: secondaryCaseAdapterProfile.revision,
    contract_source_sha256: SECONDARY_CASE_ADAPTER_CONTRACT_SHA256,
    target: secondaryCaseAdapterProfile.target,
    pins: secondaryCaseAdapterProfile.pins,
    composition: secondaryCaseAdapterProfile.composition,
    trust_boundary: secondaryCaseAdapterProfile.trust_boundary,
    compatibility: secondaryCaseAdapterProfile.compatibility,
    output: secondaryCaseAdapterProfile.output,
    authority: secondaryCaseAdapterProfile.authority,
    evidence: secondaryCaseAdapterProfile.evidence,
  };
  record(
    secondaryCaseAdapterManifest,
    'evidence.browser_relay_secondary_case_adapter',
    Object.keys(secondaryCaseAdapterExpected),
  );
  exactStructured(
    secondaryCaseAdapterManifest,
    secondaryCaseAdapterExpected,
    'evidence.browser_relay_secondary_case_adapter',
  );
  for (const [actual, expected, path] of [
    [secondaryCaseAdapterProfile.pins.browser_relay_case_scheduler_profile_sha256,
      CASE_SCHEDULER_PROFILE_SHA256,
      'pins.browser_relay_case_scheduler_profile_sha256'],
    [secondaryCaseAdapterProfile.pins.browser_relay_chromium_case_adapter_profile_sha256,
      CHROMIUM_CASE_ADAPTER_PROFILE_SHA256,
      'pins.browser_relay_chromium_case_adapter_profile_sha256'],
    [secondaryCaseAdapterProfile.pins.browser_relay_evidence_session_profile_sha256,
      EVIDENCE_SESSION_PROFILE_SHA256,
      'pins.browser_relay_evidence_session_profile_sha256'],
    [secondaryCaseAdapterProfile.pins.browser_relay_page_receipt_profile_sha256,
      PAGE_RECEIPT_PROFILE_SHA256,
      'pins.browser_relay_page_receipt_profile_sha256'],
    [secondaryCaseAdapterProfile.pins.browser_relay_playwright_bridge_profile_sha256,
      PLAYWRIGHT_BRIDGE_PROFILE_SHA256,
      'pins.browser_relay_playwright_bridge_profile_sha256'],
    [secondaryCaseAdapterProfile.pins.browser_relay_runner_profile_sha256,
      BROWSER_RELAY_RUNNER_PROFILE_SHA256,
      'pins.browser_relay_runner_profile_sha256'],
    [secondaryCaseAdapterProfile.pins.browser_relay_scenario_fixture_profile_sha256,
      SCENARIO_FIXTURE_PROFILE_SHA256,
      'pins.browser_relay_scenario_fixture_profile_sha256'],
    [secondaryCaseAdapterProfile.pins.dependency_contracts_sha256,
      SECONDARY_CASE_ADAPTER_DEPENDENCY_CONTRACTS_SHA256,
      'pins.dependency_contracts_sha256'],
    [secondaryCaseAdapterProfile.pins.implementation_base_commit,
      SECONDARY_CASE_ADAPTER_IMPLEMENTATION_BASE_COMMIT,
      'pins.implementation_base_commit'],
  ]) exact(actual, expected, `evidence.browser_relay_secondary_case_adapter.${path}`);
  exact(
    secondaryCaseAdapterProfile.compatibility.complete_three_browser_page_scenarios_composed,
    true,
    'evidence.browser_relay_secondary_case_adapter.compatibility.complete_three_browser_page_scenarios_composed',
  );
  exact(
    secondaryCaseAdapterProfile.compatibility.independent_live_source_adapters_present,
    false,
    'evidence.browser_relay_secondary_case_adapter.compatibility.independent_live_source_adapters_present',
  );
  exact(
    secondaryCaseAdapterProfile.compatibility.secondary_live_browser_providers_present,
    false,
    'evidence.browser_relay_secondary_case_adapter.compatibility.secondary_live_browser_providers_present',
  );
  exact(
    secondaryCaseAdapterProfile.compatibility.dedicated_process_browser_driver_present,
    false,
    'evidence.browser_relay_secondary_case_adapter.compatibility.dedicated_process_browser_driver_present',
  );
  exact(
    secondaryCaseAdapterProfile.compatibility.live_operation_wired,
    false,
    'evidence.browser_relay_secondary_case_adapter.compatibility.live_operation_wired',
  );
  exact(
    secondaryCaseAdapterProfile.authority.live_execution_authorized,
    false,
    'evidence.browser_relay_secondary_case_adapter.authority.live_execution_authorized',
  );
  exact(
    secondaryCaseAdapterProfile.evidence.live_execution_count,
    0,
    'evidence.browser_relay_secondary_case_adapter.evidence.live_execution_count',
  );
  const independentCaseAdapterManifest =
    manifest.evidence.browser_relay_independent_case_adapter;
  const independentCaseAdapterProfilePath = committedEvidencePath(
    stagingRoot,
    independentCaseAdapterManifest.profile_path,
    INDEPENDENT_CASE_ADAPTER_PROFILE_PATH,
    'evidence.browser_relay_independent_case_adapter.profile_path',
  );
  const independentCaseAdapterProfile = validatedEvidenceFile(
    independentCaseAdapterProfilePath,
    validateBrowserRelayIndependentCaseAdapterProfile,
    'evidence.browser_relay_independent_case_adapter.profile_path',
  );
  exact(
    fileSha256(independentCaseAdapterProfilePath),
    INDEPENDENT_CASE_ADAPTER_PROFILE_SHA256,
    'evidence.browser_relay_independent_case_adapter.profile_sha256',
  );
  exact(
    fileSha256(resolve(stagingRoot, 'browser-relay-independent-case-adapter/contract.mjs')),
    INDEPENDENT_CASE_ADAPTER_CONTRACT_SHA256,
    'evidence.browser_relay_independent_case_adapter.contract_source_sha256',
  );
  const independentCaseAdapterExpected = {
    state: independentCaseAdapterProfile.state,
    profile_path: INDEPENDENT_CASE_ADAPTER_PROFILE_PATH,
    profile_sha256: INDEPENDENT_CASE_ADAPTER_PROFILE_SHA256,
    profile_schema: independentCaseAdapterProfile.schema,
    profile_revision: independentCaseAdapterProfile.revision,
    contract_source_sha256: INDEPENDENT_CASE_ADAPTER_CONTRACT_SHA256,
    target: independentCaseAdapterProfile.target,
    pins: independentCaseAdapterProfile.pins,
    composition: independentCaseAdapterProfile.composition,
    trust_boundary: independentCaseAdapterProfile.trust_boundary,
    compatibility: independentCaseAdapterProfile.compatibility,
    output: independentCaseAdapterProfile.output,
    authority: independentCaseAdapterProfile.authority,
    evidence: independentCaseAdapterProfile.evidence,
  };
  record(
    independentCaseAdapterManifest,
    'evidence.browser_relay_independent_case_adapter',
    Object.keys(independentCaseAdapterExpected),
  );
  exactStructured(
    independentCaseAdapterManifest,
    independentCaseAdapterExpected,
    'evidence.browser_relay_independent_case_adapter',
  );
  for (const [actual, expected, path] of [
    [independentCaseAdapterProfile.pins.browser_relay_plan_sha256,
      BROWSER_RELAY_PLAN_SHA256,
      'pins.browser_relay_plan_sha256'],
    [independentCaseAdapterProfile.pins.browser_relay_case_scheduler_profile_sha256,
      CASE_SCHEDULER_PROFILE_SHA256,
      'pins.browser_relay_case_scheduler_profile_sha256'],
    [independentCaseAdapterProfile.pins.browser_relay_evidence_session_profile_sha256,
      EVIDENCE_SESSION_PROFILE_SHA256,
      'pins.browser_relay_evidence_session_profile_sha256'],
    [independentCaseAdapterProfile.pins.browser_relay_independent_observers_profile_sha256,
      INDEPENDENT_OBSERVERS_PROFILE_SHA256,
      'pins.browser_relay_independent_observers_profile_sha256'],
    [independentCaseAdapterProfile.pins.browser_relay_secondary_case_adapter_profile_sha256,
      SECONDARY_CASE_ADAPTER_PROFILE_SHA256,
      'pins.browser_relay_secondary_case_adapter_profile_sha256'],
    [independentCaseAdapterProfile.pins.dependency_contracts_sha256,
      INDEPENDENT_CASE_ADAPTER_DEPENDENCY_CONTRACTS_SHA256,
      'pins.dependency_contracts_sha256'],
    [independentCaseAdapterProfile.pins.implementation_base_commit,
      INDEPENDENT_CASE_ADAPTER_IMPLEMENTATION_BASE_COMMIT,
      'pins.implementation_base_commit'],
  ]) exact(actual, expected, `evidence.browser_relay_independent_case_adapter.${path}`);
  exact(
    independentCaseAdapterProfile.composition.observations_per_matrix,
    INDEPENDENT_FACTS_PER_MATRIX,
    'evidence.browser_relay_independent_case_adapter.composition.observations_per_matrix',
  );
  exact(
    independentCaseAdapterProfile.compatibility.complete_three_browser_page_scenarios_composed,
    true,
    'evidence.browser_relay_independent_case_adapter.compatibility.complete_three_browser_page_scenarios_composed',
  );
  exact(
    independentCaseAdapterProfile.compatibility.independent_source_composition_present,
    true,
    'evidence.browser_relay_independent_case_adapter.compatibility.independent_source_composition_present',
  );
  exact(
    independentCaseAdapterProfile.compatibility.genuine_live_source_adapters_present,
    false,
    'evidence.browser_relay_independent_case_adapter.compatibility.genuine_live_source_adapters_present',
  );
  exact(
    independentCaseAdapterProfile.compatibility.trusted_live_browser_providers_present,
    false,
    'evidence.browser_relay_independent_case_adapter.compatibility.trusted_live_browser_providers_present',
  );
  exact(
    independentCaseAdapterProfile.compatibility.live_operation_wired,
    false,
    'evidence.browser_relay_independent_case_adapter.compatibility.live_operation_wired',
  );
  exact(
    independentCaseAdapterProfile.authority.live_execution_authorized,
    false,
    'evidence.browser_relay_independent_case_adapter.authority.live_execution_authorized',
  );
  exact(
    independentCaseAdapterProfile.evidence.live_execution_count,
    0,
    'evidence.browser_relay_independent_case_adapter.evidence.live_execution_count',
  );
  const sourceTransportsManifest = manifest.evidence.browser_relay_source_transports;
  const sourceTransportsProfilePath = committedEvidencePath(
    stagingRoot,
    sourceTransportsManifest.profile_path,
    SOURCE_TRANSPORTS_PROFILE_PATH,
    'evidence.browser_relay_source_transports.profile_path',
  );
  const sourceTransportsProfile = validatedEvidenceFile(
    sourceTransportsProfilePath,
    validateBrowserRelaySourceTransportsProfile,
    'evidence.browser_relay_source_transports.profile_path',
  );
  exact(
    fileSha256(sourceTransportsProfilePath),
    SOURCE_TRANSPORTS_PROFILE_SHA256,
    'evidence.browser_relay_source_transports.profile_sha256',
  );
  exact(
    fileSha256(resolve(stagingRoot, 'browser-relay-source-transports/contract.mjs')),
    SOURCE_TRANSPORTS_CONTRACT_SHA256,
    'evidence.browser_relay_source_transports.contract_source_sha256',
  );
  const sourceTransportsExpected = {
    state: sourceTransportsProfile.state,
    profile_path: SOURCE_TRANSPORTS_PROFILE_PATH,
    profile_sha256: SOURCE_TRANSPORTS_PROFILE_SHA256,
    profile_schema: sourceTransportsProfile.schema,
    profile_revision: sourceTransportsProfile.revision,
    contract_source_sha256: SOURCE_TRANSPORTS_CONTRACT_SHA256,
    target: sourceTransportsProfile.target,
    pins: sourceTransportsProfile.pins,
    transport: {
      sources: sourceTransportsProfile.transport.source_order.length,
      stages: sourceTransportsProfile.transport.stage_count,
      observations_per_matrix: sourceTransportsProfile.transport.observations_per_matrix,
      provider_methods: sourceTransportsProfile.transport.provider_methods,
      reader_methods: sourceTransportsProfile.transport.reader_methods,
      expected_eof_required: sourceTransportsProfile.transport.expected_eof_required,
      downstream_backpressure_awaited:
        sourceTransportsProfile.transport.downstream_backpressure_awaited,
      operation_capability_noncloneable:
        sourceTransportsProfile.transport.operation_capability_noncloneable,
      provider_identity_single_operation:
        sourceTransportsProfile.transport.provider_identity_single_operation,
      reader_identity_single_stage:
        sourceTransportsProfile.transport.reader_identity_single_stage,
      source_execution_nonoverlapping:
        sourceTransportsProfile.transport.source_execution_nonoverlapping,
      source_invocation_order_exact:
        sourceTransportsProfile.transport.source_invocation_order_exact,
      late_records_suppressed: sourceTransportsProfile.transport.late_records_suppressed,
      abort_before_drain: sourceTransportsProfile.transport.abort_before_drain,
      finite_late_settlements_drained:
        sourceTransportsProfile.transport.finite_late_settlements_drained,
      stage_reader_close_exact: sourceTransportsProfile.transport.stage_reader_close_exact,
      provider_close_exact: sourceTransportsProfile.transport.provider_close_exact,
      protocol_poison_permanent: sourceTransportsProfile.transport.protocol_poison_permanent,
      raw_observations_retained: sourceTransportsProfile.transport.raw_observations_retained,
      arbitrary_errors_propagated:
        sourceTransportsProfile.transport.arbitrary_errors_propagated,
    },
    compatibility: sourceTransportsProfile.compatibility,
    authority: sourceTransportsProfile.authority,
    evidence: sourceTransportsProfile.evidence,
  };
  record(
    sourceTransportsManifest,
    'evidence.browser_relay_source_transports',
    Object.keys(sourceTransportsExpected),
  );
  exactStructured(
    sourceTransportsManifest,
    sourceTransportsExpected,
    'evidence.browser_relay_source_transports',
  );
  exactStructured(
    sourceTransportsProfile.transport.source_order,
    SOURCE_TRANSPORTS_SOURCE_ORDER,
    'evidence.browser_relay_source_transports.transport.source_order',
  );
  exact(
    sourceTransportsProfile.transport.stage_count,
    SOURCE_TRANSPORTS_STAGE_COUNT,
    'evidence.browser_relay_source_transports.transport.stage_count',
  );
  exact(
    sourceTransportsProfile.transport.observations_per_matrix,
    SOURCE_TRANSPORTS_OBSERVATIONS_PER_MATRIX,
    'evidence.browser_relay_source_transports.transport.observations_per_matrix',
  );
  exact(
    sourceTransportsProfile.compatibility.genuine_source_transport_adapters_present,
    true,
    'evidence.browser_relay_source_transports.compatibility.genuine_source_transport_adapters_present',
  );
  for (const [path, value] of [
    ['trusted_live_source_readers_present',
      sourceTransportsProfile.compatibility.trusted_live_source_readers_present],
    ['operation_case_adapter_wired',
      sourceTransportsProfile.compatibility.operation_case_adapter_wired],
    ['dedicated_process_ipc_present',
      sourceTransportsProfile.compatibility.dedicated_process_ipc_present],
    ['network_implementation_present',
      sourceTransportsProfile.compatibility.network_implementation_present],
  ]) exact(
    value,
    false,
    `evidence.browser_relay_source_transports.compatibility.${path}`,
  );
  if (Object.values(sourceTransportsProfile.authority).some((entry) => entry !== false)) {
    reject('evidence.browser_relay_source_transports.authority', 'must remain closed');
  }
  exact(sourceTransportsProfile.evidence.live_source_readers, 0,
    'evidence.browser_relay_source_transports.evidence.live_source_readers');
  exact(sourceTransportsProfile.evidence.live_source_observations, 0,
    'evidence.browser_relay_source_transports.evidence.live_source_observations');
  exact(sourceTransportsProfile.evidence.cloud_requests, 0,
    'evidence.browser_relay_source_transports.evidence.cloud_requests');
  exact(sourceTransportsProfile.evidence.cloud_mutations, 0,
    'evidence.browser_relay_source_transports.evidence.cloud_mutations');
  exact(sourceTransportsProfile.evidence.live_execution_count, 0,
    'evidence.browser_relay_source_transports.evidence.live_execution_count');
  exact(sourceTransportsProfile.evidence.incremental_monthly_cost_eur, 0,
    'evidence.browser_relay_source_transports.evidence.incremental_monthly_cost_eur');
  const authenticatedReadersManifest =
    manifest.evidence.browser_relay_authenticated_source_readers;
  const authenticatedReadersProfilePath = committedEvidencePath(
    stagingRoot,
    authenticatedReadersManifest.profile_path,
    AUTHENTICATED_SOURCE_READERS_PROFILE_PATH,
    'evidence.browser_relay_authenticated_source_readers.profile_path',
  );
  const authenticatedReadersProfile = validatedEvidenceFile(
    authenticatedReadersProfilePath,
    validateBrowserRelayAuthenticatedSourceReadersProfile,
    'evidence.browser_relay_authenticated_source_readers.profile_path',
  );
  exact(
    fileSha256(authenticatedReadersProfilePath),
    AUTHENTICATED_SOURCE_READERS_PROFILE_SHA256,
    'evidence.browser_relay_authenticated_source_readers.profile_sha256',
  );
  exact(
    fileSha256(resolve(
      stagingRoot,
    ...
    AUTHENTICATED_SOURCE_READERS_CONTRACT_SHA256,
    'evidence.browser_relay_authenticated_source_readers.contract_source_sha256',
  );
  const authenticatedReadersExpected = {
    state: authenticatedReadersProfile.state,
    profile_path: AUTHENTICATED_SOURCE_READERS_PROFILE_PATH,
    profile_sha256: AUTHENTICATED_SOURCE_READERS_PROFILE_SHA256,
    profile_schema: authenticatedReadersProfile.schema,
    profile_revision: authenticatedReadersProfile.revision,
    contract_source_sha256: AUTHENTICATED_SOURCE_READERS_CONTRACT_SHA256,
    target: authenticatedReadersProfile.target,
    pins: authenticatedReadersProfile.pins,
    reader: {
      sources: authenticatedReadersProfile.reader.source_order.length,
      stages: authenticatedReadersProfile.reader.stage_count,
      observations_per_matrix:
        authenticatedReadersProfile.reader.observations_per_matrix,
      authority_methods_by_source:
        authenticatedReadersProfile.reader.authority_methods_by_source,
      provider_methods: authenticatedReadersProfile.reader.provider_methods,
      reader_methods: authenticatedReadersProfile.reader.reader_methods,
      options_fields: authenticatedReadersProfile.reader.options_fields,
      request_fields: authenticatedReadersProfile.reader.request_fields,
      context_fields: authenticatedReadersProfile.reader.context_fields,
      maximum_authority_lifetime_milliseconds:
        authenticatedReadersProfile.reader.maximum_authority_lifetime_milliseconds,
      expiry_is_absolute_unix_epoch_milliseconds:
        authenticatedReadersProfile.reader.expiry_is_absolute_unix_epoch_milliseconds,
      kind_attenuation_exact: authenticatedReadersProfile.reader.kind_attenuation_exact,
      operation_capability_identity_bound:
        authenticatedReadersProfile.reader.operation_capability_identity_bound,
      authority_identity_single_operation:
        authenticatedReadersProfile.reader.authority_identity_single_operation,
      provider_identity_single_operation:
        authenticatedReadersProfile.reader.provider_identity_single_operation,
      reader_identity_single_stage:
        authenticatedReadersProfile.reader.reader_identity_single_stage,
      source_stages_ordered_nonoverlapping:
        authenticatedReadersProfile.reader.source_stages_ordered_nonoverlapping,
      authority_calls_lazy_ordered_nonoverlapping:
        authenticatedReadersProfile.reader.authority_calls_lazy_ordered_nonoverlapping,
      call_reserved_before_await:
        authenticatedReadersProfile.reader.call_reserved_before_await,
      abort_checked_before_and_after_call:
        authenticatedReadersProfile.reader.abort_checked_before_and_after_call,
      expiry_checked_before_and_after_call:
        authenticatedReadersProfile.reader.expiry_checked_before_and_after_call,
      abort_checked_before_and_after_close:
        authenticatedReadersProfile.reader.abort_checked_before_and_after_close,
      expiry_checked_before_and_after_close:
        authenticatedReadersProfile.reader.expiry_checked_before_and_after_close,
      caller_abort_reason_sanitized:
        authenticatedReadersProfile.reader.caller_abort_reason_sanitized,
      callback_close_reentrancy_rejected:
        authenticatedReadersProfile.reader.callback_close_reentrancy_rejected,
      expected_eof_exact: authenticatedReadersProfile.reader.expected_eof_exact,
      reader_close_exact: authenticatedReadersProfile.reader.reader_close_exact,
      provider_close_exact: authenticatedReadersProfile.reader.provider_close_exact,
      shared_poison_permanent:
        authenticatedReadersProfile.reader.shared_poison_permanent,
      terminal_authority_references_cleared:
        authenticatedReadersProfile.reader.terminal_authority_references_cleared,
      testing_authority_release_probe_present:
        authenticatedReadersProfile.reader.testing_authority_release_probe_present,
      production_clock_intrinsic:
        authenticatedReadersProfile.reader.production_clock_intrinsic,
    },
    compatibility: authenticatedReadersProfile.compatibility,
    output: authenticatedReadersProfile.output,
    authority: authenticatedReadersProfile.authority,
    evidence: authenticatedReadersProfile.evidence,
  };
  record(
    authenticatedReadersManifest,
    'evidence.browser_relay_authenticated_source_readers',
    Object.keys(authenticatedReadersExpected),
  );
  exactStructured(
    authenticatedReadersManifest,
    authenticatedReadersExpected,
    'evidence.browser_relay_authenticated_source_readers',
  );
  exactStructured(
    authenticatedReadersProfile.reader.source_order,
    AUTHENTICATED_SOURCE_READERS_SOURCE_ORDER,
    'evidence.browser_relay_authenticated_source_readers.reader.source_order',
  );
  exactStructured(
    authenticatedReadersProfile.reader.authority_methods_by_source,
    AUTHENTICATED_SOURCE_READERS_AUTHORITY_METHODS_BY_SOURCE,
    'evidence.browser_relay_authenticated_source_readers.reader.authority_methods_by_source',
  );
  exactStructured(
    authenticatedReadersProfile.reader.provider_methods,
    AUTHENTICATED_SOURCE_READERS_PROVIDER_METHODS,
    'evidence.browser_relay_authenticated_source_readers.reader.provider_methods',
  );
  exactStructured(
    authenticatedReadersProfile.reader.reader_methods,
    AUTHENTICATED_SOURCE_READERS_READER_METHODS,
    'evidence.browser_relay_authenticated_source_readers.reader.reader_methods',
  );
  exactStructured(
    authenticatedReadersProfile.reader.options_fields,
    AUTHENTICATED_SOURCE_READERS_OPTIONS_FIELDS,
    'evidence.browser_relay_authenticated_source_readers.reader.options_fields',
  );
  exactStructured(
    authenticatedReadersProfile.reader.request_fields,
    AUTHENTICATED_SOURCE_READERS_REQUEST_FIELDS,
    'evidence.browser_relay_authenticated_source_readers.reader.request_fields',
  );
  exactStructured(
    authenticatedReadersProfile.reader.context_fields,
    AUTHENTICATED_SOURCE_READERS_CONTEXT_FIELDS,
    'evidence.browser_relay_authenticated_source_readers.reader.context_fields',
  );
  exact(authenticatedReadersProfile.reader.stage_count,
    AUTHENTICATED_SOURCE_READERS_STAGE_COUNT,
    'evidence.browser_relay_authenticated_source_readers.reader.stage_count');
  exact(authenticatedReadersProfile.reader.observations_per_matrix,
    AUTHENTICATED_SOURCE_READERS_OBSERVATIONS_PER_MATRIX,
    'evidence.browser_relay_authenticated_source_readers.reader.observations_per_matrix');
  exact(authenticatedReadersProfile.reader.maximum_authority_lifetime_milliseconds,
    AUTHENTICATED_SOURCE_READERS_MAXIMUM_AUTHORITY_LIFETIME_MILLISECONDS,
    'evidence.browser_relay_authenticated_source_readers.reader.maximum_authority_lifetime_milliseconds');
  for (const path of [
    'concrete_live_source_authority_adapters_present',
    'network_implementation_present',
    'operation_case_adapter_wired',
    'trusted_live_page_providers_present',
    'dedicated_process_ipc_present',
  ]) exact(
    authenticatedReadersProfile.compatibility[path],
    false,
    `evidence.browser_relay_authenticated_source_readers.compatibility.${path}`,
  );
  if (Object.values(authenticatedReadersProfile.authority).some((entry) => entry !== false)) {
    reject('evidence.browser_relay_authenticated_source_readers.authority',
      'must remain closed');
  }
  for (const path of [
    'live_source_readers',
    ...
    authenticatedReadersProfile.evidence[path],
    0,
  ...
  const sourceClientsManifest = manifest.evidence.browser_relay_source_clients;
  const sourceClientsProfilePath = committedEvidencePath(
    stagingRoot,
    sourceClientsManifest.profile_path,
    SOURCE_CLIENTS_PROFILE_PATH,
    'evidence.browser_relay_source_clients.profile_path',
  );
  const sourceClientsProfile = validatedEvidenceFile(
    sourceClientsProfilePath,
    validateBrowserRelaySourceClientsProfile,
    'evidence.browser_relay_source_clients.profile_path',
  );
  exact(
    fileSha256(sourceClientsProfilePath),
    SOURCE_CLIENTS_PROFILE_SHA256,
    'evidence.browser_relay_source_clients.profile_sha256',
  );
  exact(
    fileSha256(resolve(stagingRoot, 'browser-relay-source-clients/contract.mjs')),
    SOURCE_CLIENTS_CONTRACT_SHA256,
    'evidence.browser_relay_source_clients.contract_source_sha256',
  );
  const sourceClientsExpected = {
    state: sourceClientsProfile.state,
    profile_path: SOURCE_CLIENTS_PROFILE_PATH,
    profile_sha256: SOURCE_CLIENTS_PROFILE_SHA256,
    profile_schema: sourceClientsProfile.schema,
    profile_revision: sourceClientsProfile.revision,
    contract_source_sha256: SOURCE_CLIENTS_CONTRACT_SHA256,
    target: sourceClientsProfile.target,
    pins: sourceClientsProfile.pins,
    clients: {
      sources: sourceClientsProfile.clients.source_order.length,
      stages: sourceClientsProfile.clients.stage_count,
      observations_per_matrix: sourceClientsProfile.clients.observations_per_matrix,
      distinct_kind_count: sourceClientsProfile.clients.distinct_kind_count,
      scopes_by_source: sourceClientsProfile.clients.scopes_by_source,
      targets_by_source_and_kind: sourceClientsProfile.clients.targets_by_source_and_kind,
      client_fields: sourceClientsProfile.clients.client_fields,
      client_descriptor_fields: sourceClientsProfile.clients.client_descriptor_fields,
      authority_fields: sourceClientsProfile.clients.authority_fields,
      options_fields: sourceClientsProfile.clients.options_fields,
      acquire_descriptor_fields: sourceClientsProfile.clients.acquire_descriptor_fields,
      receipt_fields: sourceClientsProfile.clients.receipt_fields,
      runtime_fields: sourceClientsProfile.clients.runtime_fields,
      maximum_authority_lifetime_milliseconds:
        sourceClientsProfile.clients.maximum_authority_lifetime_milliseconds,
      invariants: sourceClientsProfile.clients.invariants,
    },
    compatibility: sourceClientsProfile.compatibility,
    output: sourceClientsProfile.output,
    authority: sourceClientsProfile.authority,
    evidence: sourceClientsProfile.evidence,
  };
  record(
    sourceClientsManifest,
    'evidence.browser_relay_source_clients',
    Object.keys(sourceClientsExpected),
  );
  exactStructured(
    sourceClientsManifest,
    sourceClientsExpected,
    'evidence.browser_relay_source_clients',
  );
  exactStructured(
    sourceClientsProfile.clients.source_order,
    SOURCE_CLIENTS_SOURCE_ORDER,
    'evidence.browser_relay_source_clients.clients.source_order',
  );
  exactStructured(
    sourceClientsProfile.clients.scopes_by_source,
    SOURCE_CLIENTS_SCOPES_BY_SOURCE,
    'evidence.browser_relay_source_clients.clients.scopes_by_source',
  );
  exactStructured(
    sourceClientsProfile.clients.targets_by_source_and_kind,
    SOURCE_CLIENTS_TARGETS_BY_SOURCE_AND_KIND,
    'evidence.browser_relay_source_clients.clients.targets_by_source_and_kind',
  );
  for (const [path, actual, expected] of [
    ['client_fields', sourceClientsProfile.clients.client_fields,
      SOURCE_CLIENTS_CLIENT_FIELDS],
    ...
    actual,
    expected,
    `evidence.browser_relay_source_clients.clients.${path}`,
  );
  for (const [path, actual, expected] of [
    ['stage_count', sourceClientsProfile.clients.stage_count,
      SOURCE_CLIENTS_STAGE_COUNT],
    ['observations_per_matrix', sourceClientsProfile.clients.observations_per_matrix,
      SOURCE_CLIENTS_OBSERVATIONS_PER_MATRIX],
    ['distinct_kind_count', sourceClientsProfile.clients.distinct_kind_count,
  ...
  if (Object.values(sourceClientsProfile.clients.invariants)
    .some((entry) => entry !== true)) {
    reject('evidence.browser_relay_source_clients.clients.invariants',
      'must remain fully enforced');
  }
  for (const path of [
    'source_session_producers_compatible',
    'explicit_ephemeral_source_authorities_present',
    'fixed_target_acquisition_clients_present',
  ]) exact(
    sourceClientsProfile.compatibility[path],
    true,
    `evidence.browser_relay_source_clients.compatibility.${path}`,
  );
  for (const path of [
    'built_in_credential_discovery_present',
    'consuming_app_check_verification_present',
    'delayed_metric_inference_present',
    'operation_case_adapter_wired',
    'trusted_live_authority_providers_present',
    'dedicated_process_ipc_present',
    'preexisting_async_resource_reentrancy_isolated',
    'uncooperative_same_process_authority_forced_termination',
  ]) exact(
    sourceClientsProfile.compatibility[path],
    false,
    `evidence.browser_relay_source_clients.compatibility.${path}`,
  ...
  for (const path of [
    'explicit_ephemeral_authorities_accepted',
    'fixed_staging_targets_authorized',
  ]) exact(
    sourceClientsProfile.authority[path],
    true,
    `evidence.browser_relay_source_clients.authority.${path}`,
  );
  for (const path of [
    ...
    'case_adapter_wiring_authorized',
    'live_execution_authorized',
    'public_ingress_changes_authorized',
  ]) exact(
    sourceClientsProfile.authority[path],
    false,
    `evidence.browser_relay_source_clients.authority.${path}`,
  ...
  for (const path of [
    'live_source_authorities',
    'live_source_client_calls',
    'live_source_observations',
    'live_source_receipts',
    'cloud_requests',
    'cloud_mutations',
    ...
    sourceClientsProfile.evidence[path],
    0,
    `evidence.browser_relay_source_clients.evidence.${path}`,
  );
  const operatorAuthoritySourceManifest =
    manifest.evidence.browser_relay_operator_authority_source;
  const operatorAuthoritySourceProfilePath = committedEvidencePath(
    stagingRoot,
    operatorAuthoritySourceManifest.profile_path,
    OPERATOR_AUTHORITY_SOURCE_PROFILE_PATH,
    'evidence.browser_relay_operator_authority_source.profile_path',
  );
  const operatorAuthoritySourceProfile = validatedEvidenceFile(
    operatorAuthoritySourceProfilePath,
    validateBrowserRelayOperatorAuthoritySourceProfile,
    'evidence.browser_relay_operator_authority_source.profile_path',
  );
  exact(
    fileSha256(operatorAuthoritySourceProfilePath),
    OPERATOR_AUTHORITY_SOURCE_PROFILE_SHA256,
    'evidence.browser_relay_operator_authority_source.profile_sha256',
  );
  for (const [field, path] of Object.entries({
    contract_source_sha256: 'browser-relay-operator-authority-source/contract.mjs',
    internal_source_sha256: 'browser-relay-operator-authority-source/internal.mjs',
    production_source_sha256: 'browser-relay-operator-authority-source/source.mjs',
    testing_source_sha256: 'browser-relay-operator-authority-source/testing.mjs',
    guard_source_sha256: 'browser-relay-operator-authority-source/guard.mjs',
    check_source_sha256: 'browser-relay-operator-authority-source/check.sh',
    readme_sha256: 'browser-relay-operator-authority-source/README.md',
    unit_test_sha256: 'test/browser-relay-operator-authority-source.test.mjs',
    workflow_sha256: '../../.github/workflows/browser-relay-external-adapters.yml',
  })) exact(
    fileSha256(resolve(stagingRoot, path)),
    OPERATOR_AUTHORITY_SOURCE_DIGESTS[field],
    `evidence.browser_relay_operator_authority_source.${field}`,
  );
  const operatorAuthoritySourceExpected = {
    state: operatorAuthoritySourceProfile.state,
    profile_path: OPERATOR_AUTHORITY_SOURCE_PROFILE_PATH,
    profile_sha256: OPERATOR_AUTHORITY_SOURCE_PROFILE_SHA256,
    profile_schema: operatorAuthoritySourceProfile.schema,
    profile_revision: operatorAuthoritySourceProfile.revision,
    ...OPERATOR_AUTHORITY_SOURCE_DIGESTS,
    target: operatorAuthoritySourceProfile.target,
    pins: operatorAuthoritySourceProfile.pins,
    commands: operatorAuthoritySourceProfile.commands,
    bounds: operatorAuthoritySourceProfile.bounds,
    lifecycle: operatorAuthoritySourceProfile.lifecycle,
    limitations: operatorAuthoritySourceProfile.limitations,
    compatibility: operatorAuthoritySourceProfile.compatibility,
    authority: operatorAuthoritySourceProfile.authority,
    evidence: operatorAuthoritySourceProfile.evidence,
  };
  record(
    operatorAuthoritySourceManifest,
    'evidence.browser_relay_operator_authority_source',
    Object.keys(operatorAuthoritySourceExpected),
  );
  exactStructured(
    operatorAuthoritySourceManifest,
    operatorAuthoritySourceExpected,
    'evidence.browser_relay_operator_authority_source',
  );
  exact(
    operatorAuthoritySourceProfile.authority.configured_user_source_code_present,
    true,
    'evidence.browser_relay_operator_authority_source.authority'
      + '.configured_user_source_code_present',
  );
  for (const [path, value] of Object.entries(operatorAuthoritySourceProfile.authority)) {
    if (path !== 'configured_user_source_code_present') exact(
      value,
      false,
      `evidence.browser_relay_operator_authority_source.authority.${path}`,
    );
  }
  for (const path of [
    'real_credentials_acquired',
    'live_principal_requests',
    'cloud_requests',
    'cloud_mutations',
    'hosting_publications',
    'live_execution_count',
    'credential_persistence_events',
    'incremental_cost_eur',
  ]) exact(
    operatorAuthoritySourceProfile.evidence[path],
    0,
    `evidence.browser_relay_operator_authority_source.evidence.${path}`,
  );
  const hostingPublisherManifest = manifest.evidence.browser_relay_hosting_publisher;
  const hostingPublisherProfilePath = committedEvidencePath(
    stagingRoot,
    hostingPublisherManifest.profile_path,
    BROWSER_RELAY_HOSTING_PUBLISHER_PROFILE_PATH,
    'evidence.browser_relay_hosting_publisher.profile_path',
  );
  const hostingPublisherProfile = validatedEvidenceFile(
    hostingPublisherProfilePath,
    validateBrowserRelayHostingPublisherProfile,
    'evidence.browser_relay_hosting_publisher.profile_path',
  );
  exact(
    fileSha256(hostingPublisherProfilePath),
    BROWSER_RELAY_HOSTING_PUBLISHER_PROFILE_SHA256,
    'evidence.browser_relay_hosting_publisher.profile_sha256',
  );
  for (const [field, path] of Object.entries({
    contract_source_sha256: 'browser-relay-hosting-publisher/contract.mjs',
    internal_source_sha256: 'browser-relay-hosting-publisher/internal.mjs',
    production_source_sha256: 'browser-relay-hosting-publisher/publisher.mjs',
    testing_source_sha256: 'browser-relay-hosting-publisher/testing.mjs',
    guard_source_sha256: 'browser-relay-hosting-publisher/guard.mjs',
    check_source_sha256: 'browser-relay-hosting-publisher/check.sh',
    readme_sha256: 'browser-relay-hosting-publisher/README.md',
    unit_test_sha256: 'test/browser-relay-hosting-publisher.test.mjs',
    workflow_sha256: '../../.github/workflows/browser-relay-external-adapters.yml',
  })) exact(
    fileSha256(resolve(stagingRoot, path)),
    HOSTING_PUBLISHER_DIGESTS[field],
    `evidence.browser_relay_hosting_publisher.${field}`,
  );
  const hostingPublisherExpected = {
    state: hostingPublisherProfile.state,
    profile_path: BROWSER_RELAY_HOSTING_PUBLISHER_PROFILE_PATH,
    profile_sha256: BROWSER_RELAY_HOSTING_PUBLISHER_PROFILE_SHA256,
    profile_schema: hostingPublisherProfile.schema,
    profile_revision: hostingPublisherProfile.revision,
    ...HOSTING_PUBLISHER_DIGESTS,
    target: hostingPublisherProfile.target,
    pins: hostingPublisherProfile.pins,
    baseline: hostingPublisherProfile.baseline,
    lifecycle: hostingPublisherProfile.lifecycle,
    bounds: hostingPublisherProfile.bounds,
    credential_boundary: hostingPublisherProfile.credential_boundary,
    compatibility: hostingPublisherProfile.compatibility,
    authority: hostingPublisherProfile.authority,
    evidence: hostingPublisherProfile.evidence,
  };
  record(
    hostingPublisherManifest,
    'evidence.browser_relay_hosting_publisher',
    Object.keys(hostingPublisherExpected),
  );
  exactStructured(
    hostingPublisherManifest,
    hostingPublisherExpected,
    'evidence.browser_relay_hosting_publisher',
  );
  exact(
    hostingPublisherProfile.authority.hosting_publisher_code_present,
    true,
    'evidence.browser_relay_hosting_publisher.authority.hosting_publisher_code_present',
  );
  for (const [path, value] of Object.entries(hostingPublisherProfile.authority)) {
    if (path !== 'hosting_publisher_code_present') exact(
      value,
      false,
      `evidence.browser_relay_hosting_publisher.authority.${path}`,
    );
  }
  for (const path of [
    ...
    hostingPublisherProfile.evidence[path],
    0,
    `evidence.browser_relay_hosting_publisher.evidence.${path}`,
  );
  const trustedSourceCompositionManifest =
    manifest.evidence.browser_relay_trusted_source_composition;
  const trustedSourceCompositionProfilePath = committedEvidencePath(
    stagingRoot,
    trustedSourceCompositionManifest.profile_path,
    TRUSTED_SOURCE_COMPOSITION_PROFILE_PATH,
    'evidence.browser_relay_trusted_source_composition.profile_path',
  );
  const trustedSourceCompositionProfile = validatedEvidenceFile(
    trustedSourceCompositionProfilePath,
    validateBrowserRelayTrustedSourceCompositionProfile,
    'evidence.browser_relay_trusted_source_composition.profile_path',
  );
  exact(
    fileSha256(trustedSourceCompositionProfilePath),
    TRUSTED_SOURCE_COMPOSITION_PROFILE_SHA256,
    'evidence.browser_relay_trusted_source_composition.profile_sha256',
  );
  exact(
    fileSha256(resolve(
      stagingRoot,
    ...
    TRUSTED_SOURCE_COMPOSITION_CONTRACT_SHA256,
    'evidence.browser_relay_trusted_source_composition.contract_source_sha256',
  );
  const trustedSourceDistinctKindCount = Object.values(
    trustedSourceCompositionProfile.providers.methods_by_source,
  ).reduce((total, methods) => total + methods.length, 0);
  const trustedSourceCompositionExpected = {
    state: trustedSourceCompositionProfile.state,
    profile_path: TRUSTED_SOURCE_COMPOSITION_PROFILE_PATH,
    profile_sha256: TRUSTED_SOURCE_COMPOSITION_PROFILE_SHA256,
    profile_schema: trustedSourceCompositionProfile.schema,
    profile_revision: trustedSourceCompositionProfile.revision,
    contract_source_sha256: TRUSTED_SOURCE_COMPOSITION_CONTRACT_SHA256,
    target: trustedSourceCompositionProfile.target,
    pins: trustedSourceCompositionProfile.pins,
    composition: {
      source_order: trustedSourceCompositionProfile.providers.source_order,
      methods_by_source: trustedSourceCompositionProfile.providers.methods_by_source,
      root_fields: trustedSourceCompositionProfile.composition.root_fields,
      matrix_component_fields:
        trustedSourceCompositionProfile.composition.matrix_component_fields,
      options_fields: trustedSourceCompositionProfile.composition.options_fields,
      output_fields: trustedSourceCompositionProfile.composition.output_fields,
      provider_context_fields: trustedSourceCompositionProfile.providers.context_fields,
      source_factories: [
        'source_clients',
        'source_sessions',
      ...
      complete_source_count: trustedSourceCompositionProfile.providers.source_order.length,
      distinct_kind_count: trustedSourceDistinctKindCount,
      complete_stage_count: trustedSourceCompositionProfile.composition.stage_count,
      complete_observation_count:
        trustedSourceCompositionProfile.composition.observations_per_matrix,
      maximum_provider_lifetime_milliseconds:
        trustedSourceCompositionProfile.providers.maximum_lifetime_milliseconds,
      lifecycle_strategy: trustedSourceCompositionProfile.lifecycle.strategy,
      provider_identity_single_composition:
        trustedSourceCompositionProfile.providers.invariants.provider_identity_single_composition,
      provider_scope_and_expiry_exact:
        trustedSourceCompositionProfile.providers.invariants.provider_scope_exact
          && trustedSourceCompositionProfile.providers.invariants.provider_expiry_shared,
      named_method_source_and_kind_fixed:
        trustedSourceCompositionProfile.providers.invariants.named_method_fixes_source_and_kind,
      target_revalidated_before_provider_call:
        trustedSourceCompositionProfile.providers.invariants
          .target_revalidated_before_provider_call,
      request_capability_hidden_from_provider:
        trustedSourceCompositionProfile.providers.invariants
          .request_capability_hidden_from_provider,
      semantic_validation_before_receipt:
        trustedSourceCompositionProfile.providers.invariants.semantic_validation_before_receipt,
      source_chain_created_only_for_execute:
        trustedSourceCompositionProfile.lifecycle.invariants
          .source_chain_created_only_for_execute,
      composition_single_use:
        trustedSourceCompositionProfile.lifecycle.invariants.composition_single_use,
      scheduler_and_root_close_converge:
        trustedSourceCompositionProfile.lifecycle.invariants.scheduler_and_root_close_converge,
      pre_matrix_failure_closes_all_providers:
        trustedSourceCompositionProfile.lifecycle.invariants
          .pre_matrix_failure_closes_all_providers,
      finite_callbacks_drained_before_release:
        trustedSourceCompositionProfile.lifecycle.invariants
          .finite_callbacks_drained_before_release,
      terminal_component_references_cleared:
        trustedSourceCompositionProfile.lifecycle.invariants
          .terminal_component_references_cleared,
      same_process_cooperative_cancellation_only:
        trustedSourceCompositionProfile.lifecycle.invariants
          .cooperative_same_process_cancellation_only,
    },
    compatibility: trustedSourceCompositionProfile.compatibility,
    authority: trustedSourceCompositionProfile.authority,
    evidence: trustedSourceCompositionProfile.evidence,
  };
  record(
    trustedSourceCompositionManifest,
    'evidence.browser_relay_trusted_source_composition',
    Object.keys(trustedSourceCompositionExpected),
  );
  exactStructured(
    trustedSourceCompositionManifest,
    trustedSourceCompositionExpected,
    'evidence.browser_relay_trusted_source_composition',
  );
  exact(
    trustedSourceCompositionProfile.pins.dependency_contracts_sha256,
    TRUSTED_SOURCE_COMPOSITION_DEPENDENCY_CONTRACTS_SHA256,
    'evidence.browser_relay_trusted_source_composition.pins.dependency_contracts_sha256',
  );
  for (const [path, actual, expected] of [
    ['source_order', trustedSourceCompositionProfile.providers.source_order,
      TRUSTED_SOURCE_COMPOSITION_SOURCE_ORDER],
    ['methods_by_source', trustedSourceCompositionProfile.providers.methods_by_source,
      TRUSTED_SOURCE_COMPOSITION_PROVIDER_METHODS_BY_SOURCE],
    ['context_fields', trustedSourceCompositionProfile.providers.context_fields,
      TRUSTED_SOURCE_COMPOSITION_PROVIDER_CONTEXT_FIELDS],
    ['root_fields', trustedSourceCompositionProfile.composition.root_fields,
      TRUSTED_SOURCE_COMPOSITION_ROOT_FIELDS],
    ['matrix_component_fields',
    ...
    actual,
    expected,
    `evidence.browser_relay_trusted_source_composition.${path}`,
  );
  for (const [path, actual, expected] of [
    ['complete_source_count',
      trustedSourceCompositionProfile.providers.source_order.length,
      TRUSTED_SOURCE_COMPOSITION_SOURCE_ORDER.length],
    ['distinct_kind_count', trustedSourceDistinctKindCount, SOURCE_CLIENTS_DISTINCT_KIND_COUNT],
    ['complete_stage_count', trustedSourceCompositionProfile.composition.stage_count,
      TRUSTED_SOURCE_COMPOSITION_STAGE_COUNT],
    ['complete_observation_count',
      trustedSourceCompositionProfile.composition.observations_per_matrix,
    ...
    actual,
    expected,
    `evidence.browser_relay_trusted_source_composition.composition.${path}`,
  );
  if (Object.values(trustedSourceCompositionProfile.providers.invariants)
    .some((entry) => entry !== true)
    || Object.values(trustedSourceCompositionProfile.lifecycle.invariants)
      .some((entry) => entry !== true)) {
    reject('evidence.browser_relay_trusted_source_composition.composition',
      'must retain every reviewed provider and lifecycle invariant');
  }
  for (const path of [
    'fixed_target_source_clients_composed',
    'source_sessions_composed',
    'source_authority_adapters_composed',
    'authenticated_source_readers_composed',
    'source_transports_composed',
    'operation_case_adapter_wired',
    'named_trusted_live_provider_capabilities_present',
  ]) exact(
    trustedSourceCompositionProfile.compatibility[path],
    true,
    `evidence.browser_relay_trusted_source_composition.compatibility.${path}`,
  );
  for (const path of [
    'built_in_live_source_implementations_present',
    'trusted_live_browser_providers_present',
    'dedicated_process_ipc_present',
    'hosting_publication_wired',
    'live_operation_wired',
  ]) exact(
    trustedSourceCompositionProfile.compatibility[path],
    false,
  ...
  for (const path of [
    ...
    trustedSourceCompositionProfile.authority[path],
    true,
    `evidence.browser_relay_trusted_source_composition.authority.${path}`,
  );
  for (const path of [
    'ambient_credentials_authorized',
    'credential_bytes_accepted',
    'arbitrary_targets_authorized',
    'direct_network_implementation_authorized',
    'cloud_mutations_authorized',
    'live_execution_authorized',
  ...
  for (const path of [
    ...
    trustedSourceCompositionProfile.evidence[path],
    0,
    `evidence.browser_relay_trusted_source_composition.evidence.${path}`,
  );
  for (const path of [
    'credentials_committed',
    'raw_source_material_committed',
  ]) exact(
    trustedSourceCompositionProfile.evidence[path],
    false,
    `evidence.browser_relay_trusted_source_composition.evidence.${path}`,
  );
  const trustedProviderProcessManifest =
    manifest.evidence.browser_relay_trusted_provider_process;
  const trustedProviderProcessProfilePath = committedEvidencePath(
    stagingRoot,
    trustedProviderProcessManifest.profile_path,
    TRUSTED_PROVIDER_PROCESS_PROFILE_PATH,
    'evidence.browser_relay_trusted_provider_process.profile_path',
  );
  const trustedProviderProcessProfile = validatedEvidenceFile(
    trustedProviderProcessProfilePath,
    validateBrowserRelayTrustedProviderProcessProfile,
    'evidence.browser_relay_trusted_provider_process.profile_path',
  );
  exact(
    fileSha256(trustedProviderProcessProfilePath),
    TRUSTED_PROVIDER_PROCESS_PROFILE_SHA256,
    'evidence.browser_relay_trusted_provider_process.profile_sha256',
  );
  exact(
    fileSha256(resolve(
      stagingRoot,
    ...
    TRUSTED_PROVIDER_PROCESS_CONTRACT_SHA256,
    'evidence.browser_relay_trusted_provider_process.contract_source_sha256',
  );
  const trustedProviderProcessExpected = {
    state: trustedProviderProcessProfile.state,
    profile_path: TRUSTED_PROVIDER_PROCESS_PROFILE_PATH,
    profile_sha256: TRUSTED_PROVIDER_PROCESS_PROFILE_SHA256,
    profile_schema: trustedProviderProcessProfile.schema,
    profile_revision: trustedProviderProcessProfile.revision,
    contract_source_sha256: TRUSTED_PROVIDER_PROCESS_CONTRACT_SHA256,
    target: trustedProviderProcessProfile.target,
    pins: trustedProviderProcessProfile.pins,
    protocol: trustedProviderProcessProfile.protocol,
    ownership: trustedProviderProcessProfile.ownership,
    lifecycle: trustedProviderProcessProfile.lifecycle,
    compatibility: trustedProviderProcessProfile.compatibility,
    authority: trustedProviderProcessProfile.authority,
    evidence: trustedProviderProcessProfile.evidence,
  };
  record(
    trustedProviderProcessManifest,
    'evidence.browser_relay_trusted_provider_process',
    Object.keys(trustedProviderProcessExpected),
  );
  exactStructured(
    trustedProviderProcessManifest,
    trustedProviderProcessExpected,
    'evidence.browser_relay_trusted_provider_process',
  );
  exact(
  ...
  exactStructured(
    trustedProviderProcessProfile.target,
    {
    ...
    'evidence.browser_relay_trusted_provider_process.target',
  );
  record(
    trustedProviderProcessProfile.pins,
    'evidence.browser_relay_trusted_provider_process.pins',
    [
      'implementation_base_commit',
      'profile_v1_sha256',
      'profile_v2_sha256',
  ...
  for (const [pin, path] of [
    ...
    ['framed_channel_source_sha256',
      'browser-relay-trusted-provider-process/framed-channel.mjs'],
    ['internal_source_sha256', 'browser-relay-trusted-provider-process/internal.mjs'],
    ['process_source_sha256', 'browser-relay-trusted-provider-process/process.mjs'],
    ['worker_source_sha256', 'browser-relay-trusted-provider-process/worker.mjs'],
    ['guard_source_sha256', 'browser-relay-trusted-provider-process/guard.mjs'],
    ['workflow_sha256', '../../.github/workflows/browser-relay-trusted-provider-process.yml'],
  ]) exact(
    trustedProviderProcessProfile.pins[pin],
    fileSha256(resolve(stagingRoot, path)),
    `evidence.browser_relay_trusted_provider_process.pins.${pin}`,
  );
  ...
  for (const path of [
    ...
    'browser-relay-trusted-provider-process/test/inert-import.test.mjs',
    'browser-relay-trusted-provider-process/test/owner-bundle.test.mjs',
    'browser-relay-trusted-provider-process/test/process.test.mjs',
    'browser-relay-trusted-provider-process/test/fixtures/hostile-peer.mjs',
    'browser-relay-trusted-provider-process/test/fixtures/uncooperative-descendant.mjs',
  ]) {
    const bytes = readFileSync(resolve(stagingRoot, path));
    trustedProviderProcessTestCorpus.update(`${JSON.stringify({
      path,
  ...
  exact(
    trustedProviderProcessProfile.pins.test_corpus_sha256,
    trustedProviderProcessTestCorpus.digest('hex'),
    'evidence.browser_relay_trusted_provider_process.pins.test_corpus_sha256',
  );
  record(
    trustedProviderProcessProfile.protocol,
    'evidence.browser_relay_trusted_provider_process.protocol',
    [
      'schema',
      'version',
      'transport',
      ...
      'canonical_utf8_json_required',
      'bom_prefixed_json_rejected',
      'duplicate_object_names_rejected',
      'unsafe_numbers_rejected',
      'invalid_unicode_rejected',
      'backpressure_awaited',
      'premature_stream_close_rejected',
      'failure_waits_queued_dispatch',
  ...
  exactFields(
    trustedProviderProcessProfile.protocol,
    {
      ...
      maximum_frames_per_direction:
        TRUSTED_PROVIDER_PROCESS_MAXIMUM_FRAMES_PER_DIRECTION,
      maximum_json_depth: TRUSTED_PROVIDER_PROCESS_MAXIMUM_JSON_DEPTH,
      maximum_json_tokens: TRUSTED_PROVIDER_PROCESS_MAXIMUM_JSON_TOKENS,
      maximum_string_bytes: TRUSTED_PROVIDER_PROCESS_MAXIMUM_STRING_BYTES,
      maximum_queued_write_bytes:
        TRUSTED_PROVIDER_PROCESS_MAXIMUM_QUEUED_WRITE_BYTES,
    },
    'evidence.browser_relay_trusted_provider_process.protocol',
  ...
  exactStructured(
    trustedProviderProcessProfile.protocol.parent_to_child_messages,
    ['execute', 'cancel'],
    'evidence.browser_relay_trusted_provider_process.protocol.parent_to_child_messages',
  );
  exactStructured(
  ...
  record(
    ...
    'evidence.browser_relay_trusted_provider_process.ownership',
    [
      'dedicated_process_ipc_present',
      'one_owner_bundle_per_process',
      'owner_bundle_format',
      'owner_bundle_regular_nonexecutable_file_required',
      'owner_bundle_maximum_bytes',
      'owner_bundle_manifest_maximum_bytes',
      'owner_bundle_maximum_files',
      'owner_bundle_file_maximum_bytes',
      'owner_bundle_path_maximum_bytes',
      'owner_bundle_segment_maximum_bytes',
      'owner_bundle_sha256_required',
      'owner_bundle_read_once_without_following_symlinks',
      'owner_bundle_canonical_manifest_required',
      'owner_bundle_per_file_sha256_required',
      'owner_bundle_exact_inventory_required',
      'owner_bundle_unsafe_paths_rejected',
      'verified_bytes_materialized_to_private_workspace',
      'verified_entry_imported_by_file_url',
      'self_contained_owner_artifact_required',
      'non_builtin_module_resolution_confined_to_workspace',
      'package_scope_metadata_confined_to_workspace',
      'node_builtin_module_resolution_allowed',
      'parent_owned_workspace_cleanup',
      'parent_crash_workspace_cleanup_guaranteed',
      'provider_and_browser_graph_created_in_child_only',
      'provider_context_or_browser_handle_crosses_ipc',
      'parent_environment_inherited',
      'parent_exec_argv_inherited',
      'parent_stdio_inherited',
      'node_ipc_channel_present',
      'transferred_handles_present',
      'shell_present',
  ...
  exactFields(
    trustedProviderProcessProfile.ownership,
    {
      owner_bundle_format: 'canonical_manifest_payload_v1',
      owner_bundle_maximum_bytes:
        TRUSTED_PROVIDER_PROCESS_MAXIMUM_OWNER_BUNDLE_BYTES,
      owner_bundle_manifest_maximum_bytes:
        TRUSTED_PROVIDER_PROCESS_MAXIMUM_OWNER_BUNDLE_MANIFEST_BYTES,
  ...
  for (const path of [
    ...
    true,
    `evidence.browser_relay_trusted_provider_process.ownership.${path}`,
  );
  for (const path of [
    'parent_crash_workspace_cleanup_guaranteed',
    'provider_context_or_browser_handle_crosses_ipc',
  ...
  record(
    trustedProviderProcessProfile.lifecycle,
    ...
    [
      ...
      'operation_timeout_maximum_milliseconds',
      'cancellation_grace_maximum_milliseconds',
      'caller_abort_reason_crosses_ipc',
      'cooperative_cancel_precedes_hard_termination',
      'cooperative_cancel_sent_at_most_once',
      'hard_termination_uses_detached_process_group_sigkill',
      'parent_verifies_process_group_empty_before_settlement',
      'parent_waits_actual_child_and_pipe_close',
      'workspace_removed_after_process_group_settlement',
      'owner_close_precedes_terminal_child_message',
      'child_validates_closed_result_before_send',
      'parent_validates_closed_result_after_receive',
      'public_result_waits_process_close',
      'errors_are_fixed_codes_without_child_diagnostics',
  ...
  for (const path of [
    ...
    true,
    `evidence.browser_relay_trusted_provider_process.lifecycle.${path}`,
  );
  for (const path of [
    'import_and_construction_spawn_processes',
    'caller_abort_reason_crosses_ipc',
  ...
  record(
    trustedProviderProcessProfile.compatibility,
    'evidence.browser_relay_trusted_provider_process.compatibility',
    [
      'node_version_range',
      'ci_node_version',
      'posix_supported',
      'windows_supported',
      'dependency_bearing_owner_bundle_proven',
      'relative_esm_dependency_proven',
      'esm_and_commonjs_resolution_boundary_proven',
      'playwright_core_package_tree_proven',
      'playwright_core_version',
      'playwright_browser_metadata_resolution_proven',
      'browser_binary_packaged',
      'browser_launch_proven',
      'trusted_source_composition_can_be_bundled_by_future_owner',
      'trusted_source_composition_live_wired',
      'live_owner_bundle_present',
      'concrete_source_truth_providers_present',
      'live_browser_provider_present',
      'hosting_publication_wired',
      'live_operation_wired',
    ],
  );
  exact(
    trustedProviderProcessProfile.compatibility.node_version_range,
    '>=22.22.0 <23',
    'evidence.browser_relay_trusted_provider_process.compatibility.node_version_range',
  );
  exact(
    trustedProviderProcessProfile.compatibility.ci_node_version,
    '22.22.0',
    'evidence.browser_relay_trusted_provider_process.compatibility.ci_node_version',
  );
  exact(
    trustedProviderProcessProfile.compatibility.playwright_core_version,
    '1.62.1',
    'evidence.browser_relay_trusted_provider_process.compatibility.playwright_core_version',
  );
  for (const path of [
    'posix_supported',
    'dependency_bearing_owner_bundle_proven',
    ...
    trustedProviderProcessProfile.compatibility[path],
    true,
    `evidence.browser_relay_trusted_provider_process.compatibility.${path}`,
  );
  for (const path of [
    'windows_supported',
    'browser_binary_packaged',
  ...
  record(
    trustedProviderProcessProfile.authority,
    'evidence.browser_relay_trusted_provider_process.authority',
    [
  ...
  for (const path of [
    ...
    true,
    `evidence.browser_relay_trusted_provider_process.authority.${path}`,
  );
  for (const path of [
    'arbitrary_ipc_methods_authorized',
    'arbitrary_targets_authorized',
  ...
  record(
    trustedProviderProcessProfile.evidence,
    'evidence.browser_relay_trusted_provider_process.evidence',
    [
      'state',
      'focused_contract_runs',
      'synthetic_owner_process_runs',
      'dependency_owner_process_runs',
      'playwright_core_load_runs',
  ...
  for (const path of [
    ...
    1,
    `evidence.browser_relay_trusted_provider_process.evidence.${path}`,
  );
  for (const path of [
    'browser_launches',
    'network_requests',
  ...
  const trustedProviderOwnerManifest =
    manifest.evidence.browser_relay_trusted_provider_owner;
  const trustedProviderOwnerProfilePath = committedEvidencePath(
    stagingRoot,
    trustedProviderOwnerManifest.profile_path,
    TRUSTED_PROVIDER_OWNER_PROFILE_PATH,
    'evidence.browser_relay_trusted_provider_owner.profile_path',
  );
  const trustedProviderOwnerProfile = validatedEvidenceFile(
    trustedProviderOwnerProfilePath,
    validateBrowserRelayTrustedProviderOwnerProfile,
    'evidence.browser_relay_trusted_provider_owner.profile_path',
  );
  exact(
    fileSha256(trustedProviderOwnerProfilePath),
    TRUSTED_PROVIDER_OWNER_PROFILE_SHA256,
    'evidence.browser_relay_trusted_provider_owner.profile_sha256',
  );
  exact(
    fileSha256(resolve(
      stagingRoot,
      'browser-relay-trusted-provider-owner/contract.mjs',
    )),
    TRUSTED_PROVIDER_OWNER_CONTRACT_SHA256,
    'evidence.browser_relay_trusted_provider_owner.contract_source_sha256',
  );
  const trustedProviderOwnerExpected = {
    state: trustedProviderOwnerProfile.state,
    profile_path: TRUSTED_PROVIDER_OWNER_PROFILE_PATH,
    profile_sha256: TRUSTED_PROVIDER_OWNER_PROFILE_SHA256,
    profile_schema: trustedProviderOwnerProfile.schema,
    profile_revision: trustedProviderOwnerProfile.revision,
    contract_source_sha256: TRUSTED_PROVIDER_OWNER_CONTRACT_SHA256,
    ...
    lifecycle: trustedProviderOwnerProfile.lifecycle,
    compatibility: trustedProviderOwnerProfile.compatibility,
    authority: trustedProviderOwnerProfile.authority,
    evidence: trustedProviderOwnerProfile.evidence,
  };
  record(
    trustedProviderOwnerManifest,
    'evidence.browser_relay_trusted_provider_owner',
    Object.keys(trustedProviderOwnerExpected),
  );
  exactStructured(
    trustedProviderOwnerManifest,
    trustedProviderOwnerExpected,
    'evidence.browser_relay_trusted_provider_owner',
  );
  exact(
  ...
  exact(
    trustedProviderOwnerProfile.pins.implementation_base_commit,
    TRUSTED_PROVIDER_OWNER_IMPLEMENTATION_BASE_COMMIT,
    'evidence.browser_relay_trusted_provider_owner.pins.implementation_base_commit',
  );
  exact(
  ...
  exactStructured(
    ...
    TRUSTED_PROVIDER_OWNER_SOURCE_ORDER,
    'evidence.browser_relay_trusted_provider_owner.graph.provider_sources',
  );
  exactStructured(
    trustedProviderOwnerProfile.graph.browser_order,
    TRUSTED_PROVIDER_OWNER_BROWSER_ORDER,
    'evidence.browser_relay_trusted_provider_owner.graph.browser_order',
  );
  for (const [path, actual, expected] of [
    ['stage_count', trustedProviderOwnerProfile.graph.stage_count,
      TRUSTED_PROVIDER_OWNER_STAGE_COUNT],
    ['observation_count', trustedProviderOwnerProfile.graph.observation_count,
      TRUSTED_PROVIDER_OWNER_OBSERVATION_COUNT],
    ['assertion_count', trustedProviderOwnerProfile.graph.assertion_count,
      TRUSTED_PROVIDER_OWNER_ASSERTION_COUNT],
  ]) exact(
    actual,
    expected,
  ...
  for (const path of [
    ...
    true,
    `evidence.browser_relay_trusted_provider_owner.authority.${path}`,
  );
  for (const path of [
    'persistent_tls_material_authorized',
    'external_network_authorized',
    'ambient_credentials_authorized',
    'cloud_or_user_credential_bytes_authorized',
    'arbitrary_targets_authorized',
  ...
  for (const [path, expected] of [
    ...
    ['real_browser_launches', TRUSTED_PROVIDER_OWNER_BROWSER_ORDER.length],
    ['loopback_tls_listener_runs', 1],
    ['route_intercepted_secondary_page_runs', 2],
    ['blocked_external_request_probes', 4],
    ['ephemeral_tls_key_files_retained', 0],
    ['dns_requests', 0],
    ...
    trustedProviderOwnerProfile.evidence[path],
    expected,
    `evidence.browser_relay_trusted_provider_owner.evidence.${path}`,
  );
  for (const path of ['credentials_committed', 'raw_source_material_committed']) exact(
    trustedProviderOwnerProfile.evidence[path],
    false,
    `evidence.browser_relay_trusted_provider_owner.evidence.${path}`,
  );
  ...
  const chromiumScenarioProfilePath = committedEvidencePath(
    stagingRoot,
    chromiumScenarioManifest.profile_path,
    CHROMIUM_SCENARIO_PROFILE_PATH,
    'evidence.chromium_scenario_automation.profile_path',
  );
  const browserRelayChromiumScenarioProfile = validatedEvidenceFile(
    chromiumScenarioProfilePath,
    validateBrowserRelayChromiumScenarioProfile,
    'evidence.chromium_scenario_automation.profile_path',
  );
  exact(
    fileSha256(chromiumScenarioProfilePath),
    CHROMIUM_SCENARIO_PROFILE_SHA256,
    'evidence.chromium_scenario_automation.profile_sha256',
  );
  exact(
    fileSha256(resolve(stagingRoot, 'browser-relay-chromium-scenario/contract.mjs')),
    CHROMIUM_SCENARIO_CONTRACT_SHA256,
    'evidence.chromium_scenario_automation.contract_source_sha256',
  );
  const chromiumScenarioExpected = {
    state: browserRelayChromiumScenarioProfile.state,
    profile_path: CHROMIUM_SCENARIO_PROFILE_PATH,
    profile_sha256: CHROMIUM_SCENARIO_PROFILE_SHA256,
    profile_schema: browserRelayChromiumScenarioProfile.schema,
    profile_revision: browserRelayChromiumScenarioProfile.revision,
    contract_source_sha256: CHROMIUM_SCENARIO_CONTRACT_SHA256,
    target: browserRelayChromiumScenarioProfile.target,
    pins: browserRelayChromiumScenarioProfile.pins,
    scenario: browserRelayChromiumScenarioProfile.scenario,
    bfcache: browserRelayChromiumScenarioProfile.bfcache,
    timing: browserRelayChromiumScenarioProfile.timing,
    trust_boundary: browserRelayChromiumScenarioProfile.trust_boundary,
    lifecycle: browserRelayChromiumScenarioProfile.lifecycle,
    compatibility: browserRelayChromiumScenarioProfile.compatibility,
    output: browserRelayChromiumScenarioProfile.output,
    authority: browserRelayChromiumScenarioProfile.authority,
    evidence: browserRelayChromiumScenarioProfile.evidence,
  };
  record(
    chromiumScenarioManifest,
    'evidence.chromium_scenario_automation',
    Object.keys(chromiumScenarioExpected),
  );
  exactStructured(
    chromiumScenarioManifest,
    chromiumScenarioExpected,
    'evidence.chromium_scenario_automation',
  );
  exact(
    browserRelayChromiumScenarioProfile.pins.browser_relay_page_profile_sha256,
    BROWSER_RELAY_PAGE_PROFILE_SHA256,
    'evidence.chromium_scenario_automation.pins.browser_relay_page_profile_sha256',
  );
  exact(
    browserRelayChromiumScenarioProfile.pins.browser_relay_page_receipt_profile_sha256,
    PAGE_RECEIPT_PROFILE_SHA256,
    'evidence.chromium_scenario_automation.pins.browser_relay_page_receipt_profile_sha256',
  );
  exact(
    browserRelayChromiumScenarioProfile.pins.browser_relay_scenario_fixture_profile_sha256,
    SCENARIO_FIXTURE_PROFILE_SHA256,
    'evidence.chromium_scenario_automation.pins.browser_relay_scenario_fixture_profile_sha256',
  );
  exact(
    browserRelayChromiumScenarioProfile.pins.browser_relay_playwright_bridge_profile_sha256,
    PLAYWRIGHT_BRIDGE_PROFILE_SHA256,
    'evidence.chromium_scenario_automation.pins.browser_relay_playwright_bridge_profile_sha256',
  );
  exact(
    browserRelayChromiumScenarioProfile.pins.browser_relay_case_scheduler_profile_sha256,
    CASE_SCHEDULER_PROFILE_SHA256,
    'evidence.chromium_scenario_automation.pins.browser_relay_case_scheduler_profile_sha256',
  );
  exact(
    browserRelayChromiumScenarioProfile.pins.playwright_types_sha256,
    PLAYWRIGHT_TYPES_SHA256,
    'evidence.chromium_scenario_automation.pins.playwright_types_sha256',
  );
  exact(
    browserRelayChromiumScenarioProfile.compatibility.complete_chromium_page_scenario,
    true,
    'evidence.chromium_scenario_automation.compatibility.complete_chromium_page_scenario',
  );
  exact(
    browserRelayChromiumScenarioProfile.compatibility.bfcache_capable_automation,
    true,
    'evidence.chromium_scenario_automation.compatibility.bfcache_capable_automation',
  );
  exact(
    browserRelayChromiumScenarioProfile.scenario.page_projection_record_awaited,
    true,
    'evidence.chromium_scenario_automation.scenario.page_projection_record_awaited',
  );
  exact(
    browserRelayChromiumScenarioProfile.compatibility
      .case_scheduler_projection_port_compatible,
    true,
    'evidence.chromium_scenario_automation.compatibility.case_scheduler_projection_port_compatible',
  );
  exact(
    browserRelayCaseSchedulerProfile.compatibility.complete_chromium_page_scenario,
    false,
    'evidence.browser_relay_case_scheduler.compatibility.complete_chromium_page_scenario',
  );
  exact(
    browserRelayCaseSchedulerProfile.compatibility.bfcache_capable_automation,
    false,
    'evidence.browser_relay_case_scheduler.compatibility.bfcache_capable_automation',
  );
  ...
  exact(
    browserRelayChromiumScenarioProfile.compatibility.legacy_playwright_bridge_chromium_blocked,
    browserRelayPlaywrightBridgeProfile.compatibility
      .chromium_blocked_before_page_or_private_input,
    'evidence.chromium_scenario_automation.compatibility.legacy_playwright_bridge_chromium_blocked',
  );
  exact(
    browserRelayChromiumScenarioProfile.bfcache.playwright_high_level_supported,
    browserRelayPlaywrightBridgeProfile.compatibility.playwright_bfcache_testing_supported,
    'evidence.chromium_scenario_automation.bfcache.playwright_high_level_supported',
  );
  ...
  const operationCaseAdapterManifest =
    manifest.evidence.browser_relay_operation_case_adapter;
  const operationCaseAdapterProfilePath = committedEvidencePath(
    stagingRoot,
    operationCaseAdapterManifest.profile_path,
    OPERATION_CASE_ADAPTER_PROFILE_PATH,
    'evidence.browser_relay_operation_case_adapter.profile_path',
  );
  const operationCaseAdapterProfile = validatedEvidenceFile(
    operationCaseAdapterProfilePath,
    validateBrowserRelayOperationCaseAdapterProfile,
    'evidence.browser_relay_operation_case_adapter.profile_path',
  );
  exact(
    fileSha256(operationCaseAdapterProfilePath),
    OPERATION_CASE_ADAPTER_PROFILE_SHA256,
    'evidence.browser_relay_operation_case_adapter.profile_sha256',
  );
  exact(
    fileSha256(resolve(stagingRoot, 'browser-relay-operation-case-adapter/contract.mjs')),
    OPERATION_CASE_ADAPTER_CONTRACT_SHA256,
    'evidence.browser_relay_operation_case_adapter.contract_source_sha256',
  );
  const operationCaseAdapterExpected = {
    state: operationCaseAdapterProfile.state,
    profile_path: OPERATION_CASE_ADAPTER_PROFILE_PATH,
    profile_sha256: OPERATION_CASE_ADAPTER_PROFILE_SHA256,
    profile_schema: operationCaseAdapterProfile.schema,
    profile_revision: operationCaseAdapterProfile.revision,
    contract_source_sha256: OPERATION_CASE_ADAPTER_CONTRACT_SHA256,
    target: operationCaseAdapterProfile.target,
    pins: operationCaseAdapterProfile.pins,
    composition: operationCaseAdapterProfile.composition,
    trust_boundary: operationCaseAdapterProfile.trust_boundary,
    compatibility: operationCaseAdapterProfile.compatibility,
    output: operationCaseAdapterProfile.output,
    authority: operationCaseAdapterProfile.authority,
    evidence: operationCaseAdapterProfile.evidence,
  };
  record(
    operationCaseAdapterManifest,
    'evidence.browser_relay_operation_case_adapter',
    Object.keys(operationCaseAdapterExpected),
  );
  exactStructured(
    operationCaseAdapterManifest,
    operationCaseAdapterExpected,
    'evidence.browser_relay_operation_case_adapter',
  );
  for (const [actual, expected, path] of [
    [operationCaseAdapterProfile.pins.browser_relay_plan_sha256,
      BROWSER_RELAY_PLAN_SHA256,
      'pins.browser_relay_plan_sha256'],
    [operationCaseAdapterProfile.pins.browser_relay_independent_case_adapter_profile_sha256,
      INDEPENDENT_CASE_ADAPTER_PROFILE_SHA256,
      'pins.browser_relay_independent_case_adapter_profile_sha256'],
    [operationCaseAdapterProfile.pins.browser_relay_operation_profile_sha256,
      OPERATION_PROFILE_SHA256,
      'pins.browser_relay_operation_profile_sha256'],
    [operationCaseAdapterProfile.pins.browser_relay_orchestrator_claim_source_sha256,
      OPERATION_CASE_ADAPTER_ORCHESTRATOR_CLAIM_SOURCE_SHA256,
      'pins.browser_relay_orchestrator_claim_source_sha256'],
    [operationCaseAdapterProfile.pins.dependency_contracts_sha256,
      OPERATION_CASE_ADAPTER_DEPENDENCY_CONTRACTS_SHA256,
      'pins.dependency_contracts_sha256'],
    [operationCaseAdapterProfile.pins.implementation_base_commit,
      OPERATION_CASE_ADAPTER_IMPLEMENTATION_BASE_COMMIT,
      'pins.implementation_base_commit'],
  ]) exact(actual, expected, `evidence.browser_relay_operation_case_adapter.${path}`);
  exact(
    operationCaseAdapterProfile.composition.maximum_claim_acquisitions,
    1,
    'evidence.browser_relay_operation_case_adapter.composition.maximum_claim_acquisitions',
  );
  exact(
    operationCaseAdapterProfile.composition.maximum_matrix_invocations,
    1,
    'evidence.browser_relay_operation_case_adapter.composition.maximum_matrix_invocations',
  );
  exact(
    operationCaseAdapterProfile.composition.claim_capability_private_to_composition,
    true,
    'evidence.browser_relay_operation_case_adapter.composition.claim_capability_private_to_composition',
  );
  exact(
    operationCaseAdapterProfile.compatibility.durable_claim_matrix_binding_present,
    true,
    'evidence.browser_relay_operation_case_adapter.compatibility.durable_claim_matrix_binding_present',
  );
  exact(
    operationCaseAdapterProfile.compatibility.operation_result_unchanged,
    true,
    'evidence.browser_relay_operation_case_adapter.compatibility.operation_result_unchanged',
  );
  exact(
    operationCaseAdapterProfile.compatibility.live_operation_wired,
    false,
    'evidence.browser_relay_operation_case_adapter.compatibility.live_operation_wired',
  );
  exact(
    operationCaseAdapterProfile.trust_boundary.claim_lineage_exposed_to_components,
    false,
    'evidence.browser_relay_operation_case_adapter.trust_boundary.claim_lineage_exposed_to_components',
  );
  exact(
    operationCaseAdapterProfile.authority.live_execution_authorized,
    false,
    'evidence.browser_relay_operation_case_adapter.authority.live_execution_authorized',
  );
  exact(
    operationCaseAdapterProfile.evidence.live_execution_count,
    0,
    'evidence.browser_relay_operation_case_adapter.evidence.live_execution_count',
  );
  ...
  return Object.freeze({
    ...
    browserRelayChromiumCaseAdapterProfile: chromiumCaseAdapterProfile,
    browserRelaySecondaryCaseAdapterProfile: secondaryCaseAdapterProfile,
    ...
    browserRelaySourceClientsProfile: sourceClientsProfile,
    browserRelayOperatorAuthoritySourceProfile: operatorAuthoritySourceProfile,
    browserRelayHostingPublisherProfile: hostingPublisherProfile,
    browserRelayTrustedSourceCompositionProfile: trustedSourceCompositionProfile,
    browserRelayTrustedProviderProcessProfile: trustedProviderProcessProfile,
    browserRelayTrustedProviderOwnerProfile: trustedProviderOwnerProfile,
    ...
    browserRelayOperationCaseAdapterProfile: operationCaseAdapterProfile,
