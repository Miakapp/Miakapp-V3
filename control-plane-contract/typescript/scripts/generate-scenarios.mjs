...
const componentOperations = [
  ...
  operation('request_upload', {
    token_ref: 'publisher-token',
    home_id: 'component-home',
    upload_ref: 'zero-size-upload',
    capability_ref: 'zero-size-capability',
    release: '2026-08-31.zero-size',
    abi: 'miakapp.component/1',
    requires,
    digest: evidence.a.digest,
    size: 0,
  }, 'error', 'invalid_request'),
  operation('request_upload', {
    token_ref: 'publisher-token',
    home_id: 'component-home',
    upload_ref: 'oversized-upload',
    capability_ref: 'oversized-capability',
    release: '2026-08-31.oversized',
    abi: 'miakapp.component/1',
    requires,
    digest: evidence.a.digest,
    size: 2_097_153,
