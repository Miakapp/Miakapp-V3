...
SDK clients. The production factories use explicit metadata-only identities, but
the tests perform no metadata, App Check, FCM, Storage, KMS or Secret Manager
network call and therefore close none of `STAGE-01`, `STAGE-03`, `STAGE-04` or
`STAGE-06`.
