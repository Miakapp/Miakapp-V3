        ...
        <div class="menuItems">
          ...
          >
            ...
            <div class="rowItem" v-if="relation.user.admin"
              ...
              <!-- eslint-disable-next-line -->
              <svg v-if="$route.params.home === relation.home.id && $route.params.page === 'admin'" viewBox="0 0 60 100"><path d="M5.271,100c-1.349,0-2.697-0.515-3.727-1.544c-2.059-2.059-2.059-5.395,0-7.454L42.546,50L1.544,8.998  c-2.059-2.059-2.059-5.395,0-7.454s5.395-2.059,7.454,0l44.729,44.729c2.059,2.059,2.059,5.395,0,7.454L8.998,98.456 C7.969,99.485,6.62,100,5.271,100z"/></svg>
            </div>
            ...
            <div class="rowItem" @click="selectPage(relation.home.id)">
              ...
              <!-- eslint-disable-next-line -->
              <svg v-if="$route.params.home === relation.home.id && !$route.params.page" viewBox="0 0 60 100"><path d="M5.271,100c-1.349,0-2.697-0.515-3.727-1.544c-2.059-2.059-2.059-5.395,0-7.454L42.546,50L1.544,8.998  c-2.059-2.059-2.059-5.395,0-7.454s5.395-2.059,7.454,0l44.729,44.729c2.059,2.059,2.059,5.395,0,7.454L8.998,98.456 C7.969,99.485,6.62,100,5.271,100z"/></svg>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    path() {
      ...
      const page = (this.$route.params.page === 'admin'
        ? { id: 'admin', name: 'Admin' }
